...
public static class Acquisition {
    ...
    static double Model(BrdfSample s, double[] p, Option<ComplexIor> conductor) =>
        Reflectance(s, p[0], p[1], p.Length == 3 ? p[2] : 1.5, conductor);
