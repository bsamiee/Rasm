...
| :-----: | :------------------- | :------------------- | :--------------------------------------------------------------------------------------- |
|   [1]   | `sparse.SparseArray` | abstract base        | `SparseArray(shape, fill_value=None)`                                                    |
|   [2]   | `sparse.COO`         | coordinate           | `COO(coords, data=None, shape=None, has_duplicates=True, sorted=False, fill_value=None)` |
|   [3]   | `sparse.GCXS`        | compressed (CSR/CSC) | `GCXS(arg, shape=None, compressed_axes=None, fill_value=None)`                           |
|   [4]   | `sparse.DOK`         | dictionary of keys   | `DOK(shape, data=None, dtype=None, fill_value=None)`                                     |
...
| :-----: | :-------------- | :--------------------------------------------------------------------------------------------- |
|   [1]   | properties      | `nnz`, `ndim`, `size`, `dtype`, `density`, `fill_value`, `shape`, `nbytes`                     |
|   [2]   | conversion      | `todense`, `asformat`, `astype`, `to_scipy_sparse`, `from_numpy`, `from_scipy_sparse`          |
|   [3]   | reduction       | `reduce`, `sum`, `prod`, `mean`, `std`, `var`, `max`, `min`, `all`, `any`                      |
|   [4]   | transform       | `reshape`, `transpose`, `T`, `mT`, `clip`, `conj`, `round`                                     |
|   [5]   | COO/GCXS extra  | `from_iter` (COO), `linear_loc` (COO), `change_compressed_axes` (GCXS), `from_coo` (GCXS, DOK) |
...
| :-----: | :----------------------------------------------------------------------------- | :--------- | :-------------------- |
|   [1]   | `zeros(shape, dtype=float, format='coo')`                                      | creation   | empty sparse array    |
|   [2]   | `ones(shape, dtype=float, format='coo')`                                       | creation   | filled sparse array   |
|   [3]   | `full(shape, fill_value, dtype=None, format='coo')`                            | creation   | constant sparse array |
|   [4]   | `eye(N, M=None, k=0, dtype=float, format='coo')`                               | creation   | identity              |
|   [5]   | `empty(shape, dtype=float, format='coo')`                                      | creation   | uninitialised         |
|   [6]   | `random(shape, density=None, nnz=None, format='coo', fill_value=None)`         | creation   | random sparse array   |
|   [7]   | `asarray(obj, /, *, dtype=None, format=None, copy=False)`                      | conversion | sparse array          |
|   [8]   | `asCOO(x, name='asCOO', check=True)`, `as_coo(x, shape=None, fill_value=None)` | conversion | `COO`                 |
|   [9]   | `asnumpy(a, dtype=None, order=None)`                                           | conversion | dense `ndarray`       |
...
| :-----: | :-------------------------------------------------------------------------------------------------- | :---------- |
|   [1]   | `dot(a, b)`, `matmul(a, b)`, `vecdot(x1, x2, /, *, axis=-1)`                                        | matrix mul  |
|   [2]   | `tensordot(a, b, axes=2, *, return_type=None)`, `einsum(*operands)`                                 | contraction |
|   [3]   | `kron(a, b)`, `outer(a, b, out=None)`                                                               | products    |
|   [4]   | `stack(arrays, axis=0)`, `concat(arrays, axis=0)`, `concatenate(arrays, axis=0)`                    | join        |
|   [5]   | `broadcast_to(x, /, shape)`, `broadcast_arrays(*arrays)`, `expand_dims(x, /, *, axis=0)`            | broadcast   |
|   [6]   | `reshape(x, /, shape)`, `squeeze(x, /, axis=None)`, `moveaxis(a, source, destination)`              | reshape     |
|   [7]   | `permute_dims(x, /, axes=None)`, `matrix_transpose(x, /)`, `flip(x, /, *, axis=None)`               | axes        |
|   [8]   | `roll(a, shift, axis=None)`, `pad(array, pad_width, mode='constant')`, `unstack(x, axis=0)`         | rearrange   |
|   [9]   | `tile(a, reps)`, `repeat(a, repeats, axis=None)`, `take(x, indices, /, *, axis=None)`               | replicate   |
...
| :-----: | :------------ | :------------------------------------------------------------------------------------------------------------------------------- |
|   [1]   | dispatch      | `elemwise(func, *args, **kwargs)`, `where(condition, x=None, y=None)`                                                            |
|   [2]   | reduction     | `sum`, `prod`, `mean`, `std`, `var`, `max`, `min`, `all`, `any`, `argmax`, `argmin`, `nonzero`                                   |
|   [3]   | nan reduction | `nansum`, `nanprod`, `nanmean`, `nanmax`, `nanmin`, `nanreduce`                                                                  |
|   [4]   | math          | `abs`, `sqrt`, `square`, `exp`, `log`, `log2`, `log10`, `log1p`, `expm1`, `sign`, `reciprocal`, `negative`                       |
|   [5]   | trig          | `sin`, `cos`, `tan`, `sinh`, `cosh`, `tanh`, `asin`, `acos`, `atan`, `atan2`                                                     |
|   [6]   | rounding      | `ceil`, `floor`, `round`, `trunc`                                                                                                |
|   [7]   | comparison    | `equal`, `not_equal`, `less`, `less_equal`, `greater`, `greater_equal`                                                           |
|   [8]   | logic         | `logical_and`, `logical_or`, `logical_xor`, `logical_not`, `isfinite`, `isinf`, `isnan`, `isposinf`, `isneginf`                  |
|   [9]   | bitwise       | `bitwise_and`, `bitwise_or`, `bitwise_xor`, `bitwise_invert`, `bitwise_left_shift`, `bitwise_right_shift`                        |
