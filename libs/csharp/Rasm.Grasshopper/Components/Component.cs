...
public abstract partial record ComponentValidationFault : Domain.Expected {
    ...
    public override string Message => Switch(
        ...
        portCountExceeded: static fault => string.Create(System.Globalization.CultureInfo.InvariantCulture, $"output port count {fault.Found} exceeds {fault.Max}"),
        sourceNotDeclared: static fault => $"output input '{fault.Input}' is not a declared input port instance",
        nullPort: static fault => string.Create(System.Globalization.CultureInfo.InvariantCulture, $"{fault.Side} {fault.Index} is null"),
        ...
        catalogPluginCount: static fault => string.Create(System.Globalization.CultureInfo.InvariantCulture, $"{fault.Assembly}: expected one plugin type, found {fault.Found}"),
