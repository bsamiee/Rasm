...
// Charter rows: RestartBudget 1, retention 7 days with green runs pruned, and one deadline row
// per non-terminal state (the stuck-state law's static half).
public sealed class PolicyLaws {
    [Fact]
    public void CharterRowsHold() {
