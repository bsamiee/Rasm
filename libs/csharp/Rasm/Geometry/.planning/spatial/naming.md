...
- Packages: `Rasm`/Vectors (`MeshSpace`, native `Mesh` topology — composed), `Rasm` (the kernel `Domain.ContentHash` seed-zero entry — composed, no second hasher), Thinktecture.Runtime.Extensions, LanguageExt.Core, BCL inbox.
...
public readonly partial struct TopoSignature {
    public static TopoSignature Of(EntityKind kind, ReadOnlySpan<TopoName> incidentNames, ReadOnlySpan<int> kindHistogram) {
        ...
        return From(Rasm.Domain.ContentHash.Of(buffer.WrittenSpan));
    }
