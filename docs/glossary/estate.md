...
Structural vocabulary binds the whole repo: a rank, boundary, unit, or corpus-surface name means one thing at the cross-libs core and inside a leaf page alike.
