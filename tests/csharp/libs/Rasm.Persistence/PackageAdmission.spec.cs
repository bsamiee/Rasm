...
public sealed class PackageAdmissionLaws {
    ...
    public void PersistenceStorePackagesAreCentralAndManagedSpecsCarryNoRuntimeProofPackages() {
        ...
        app.IncludesPackages("DuckDB.NET.Data.Full", "Google.Cloud.Storage.V1", "Microsoft.EntityFrameworkCore.Design", "Npgsql.NetTopologySuite", "Thinktecture.Runtime.Extensions.EntityFrameworkCore10");
