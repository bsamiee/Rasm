...
`VividOrange.ForceMomentInteraction` is verified-transitive through direct package `VividOrange.InteractionDiagram` and is the concrete half of the column biaxial capacity hull — the
...
(`api-vividorange-serialization.md` [TRANSITIVE_UNITSNET_JSONNET]).
...
| [INDEX] | [SURFACE] | [CALL_SHAPE] | [CAPABILITY] |
|:-----: |:------------------------------------------------------------- |:------------- |:----------------------------------------------------------------------------- |
| [01] | `new ForceMomentMesh` | constructor | an empty hull (default olive brush `(128,128,0)`, opacity) |
