...
public sealed record BimModel(
    ...
    public static Fin<BimModel> Project(IfcSemanticModel semantic, ClockPolicy clocks) =>
        semantic.Products
            .Traverse(row => IfcClass.TryGet(row.EntityType)
