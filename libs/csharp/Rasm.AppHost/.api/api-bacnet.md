...
| :-----: | :----------------------------------------- | :----- | :------------- |
|  [01]   | `BacnetClient(IBacnetTransport, int, int)` | ctor   | `BacnetClient` |
|  [02]   | `BacnetClient(int, int, int)`              | ctor   | `BacnetClient` |
|  [03]   | `BacnetClient.Start`                       | call   | `void`         |
|  [04]   | `BacnetClient.WhoIs`                       | call   | `void`         |
|  [05]   | `BacnetClient.OnIam`                       | event  | callback       |
|  [06]   | `BacnetClient.OnWhoIs`                     | event  | callback       |
|  [07]   | `BacnetClient.OnCOVNotification`           | event  | callback       |
|  [08]   | `BacnetClient.OnEventNotify`               | event  | callback       |
...
| [INDEX] | [MEMBER]                      | [KIND]     | [RETURN]       |
| :-----: | :---------------------------- | :--------- | :------------- |
|  [01]   | `ReadPropertyRequest`         | read       | `bool`         |
|  [02]   | `BeginReadPropertyRequest`    | async read | `IAsyncResult` |
|  [03]   | `ReadPropertyMultipleRequest` | read       | `bool`         |
|  [04]   | `WritePropertyRequest`        | write      | `bool`         |
|  [05]   | `SubscribeCOVRequest`         | subscribe  | `bool`         |
...
- `WritePropertyRequest(BacnetAddress adr, BacnetObjectId objectId, BacnetPropertyIds propertyId, IEnumerable<BacnetValue> valueList, byte invokeId = 0)`
- `SubscribeCOVRequest(BacnetAddress adr, BacnetObjectId objectId, uint subscribeId, bool cancel, bool issueConfirmedNotifications, uint lifetime, byte invokeId = 0)`
- `ReadRangeRequest(BacnetAddress adr, BacnetObjectId objectId, DateTime readFrom, ref uint quantity, out byte[] range, byte invokeId = 0)`
