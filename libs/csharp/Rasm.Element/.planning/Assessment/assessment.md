  ...
  !Outcome.Next().Exists(row => row == next)
   ...
   : diagnostic.IsSome != (next == AssessmentOutcome.Cancelled)
    ...
    : Fin.Succ(new AssessmentPayload(
       ...
       ResultBlob, DependsOn, Provenance));
}
```
