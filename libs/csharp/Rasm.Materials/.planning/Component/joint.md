...
using LanguageExt;
using Rasm.Vectors;                  // PositiveMagnitude (>0 finite — throat/leg/size/length/bond-line/overlap/width/spacing)
...
using Dimension = Rasm.Element.Dimension;   // the SI-dimension axis — disambiguated from the Rasm.Vectors discrete count
