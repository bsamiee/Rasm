...
- `docs/standards/AGENTS.md`: confirms active standards must stay durable and route each rule to its owner; `_reports/` research is input material only.
...
[WORKTREE_CONTEXT]:
- `git status --short -- docs/standards/reference/code-documentation.md docs/standards/_reports/code-documentation-050626/track-bash/05-bash-antipatterns.md` showed `docs/standards/reference/code-documentation.md` already modified before this report write.
...
11. Wrote only this assigned `_reports/` report.

## [11][CLOSE_CHECK]

- [x] Assigned report file created at `docs/standards/_reports/code-documentation-050626/track-bash/05-bash-antipatterns.md`.
