...
public abstract partial record Arrangement {
    ...
    static Option<CrossSegment> SegmentOf(Triangle ta, Triangle tb) {
        ...
        ImplicitCrossing[] ordered = [.. endpoints.OrderBy(c => (c.Point - endpoints[0].Point) * axis)];
