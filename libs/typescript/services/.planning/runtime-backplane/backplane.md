...
One cluster: `[2]-[RUNNER_AND_SCHEDULING]` owns the four-row runner backplane, the snowflake id source, the cluster singletons, and the shard-pinned durable cron.
