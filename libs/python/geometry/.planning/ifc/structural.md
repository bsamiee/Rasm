...
class Section(Struct, frozen=True, gc=False):
    ...
    @staticmethod
    def framed(sections: "Block[Section]") -> "RuntimeRail[EvidenceFrame]":
...
class IfcStructural:
    ...
    def _integrate(rings: ProfileRings, group: ProfileGroup, spec: str) -> "RuntimeRail[Section]":
