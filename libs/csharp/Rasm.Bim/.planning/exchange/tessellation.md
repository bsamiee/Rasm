...
public sealed record TessellationRequest(
    ...
    public Fin<TessellationOutcome> Resolve(TessellationStore store, TessellationCompanion companion, ClockPolicy clocks, Op key) {
        ...
        return store.Lookup(ArtifactKey)
            ...
            .Bind(hit => hit.Match(
                Some: glb => Reenter(glb, TessellationOrigin.Cached, clocks, at),
                None: () => companion.Cross(this)
                    ...
                    .Bind(glb => store.Store(ArtifactKey, glb)
                        ...
                        .Bind(_ => Reenter(glb, TessellationOrigin.Tessellated, clocks, at)))));
    }

    Fin<TessellationOutcome> Reenter(ReadOnlyMemory<byte> glb, TessellationOrigin origin, ClockPolicy clocks, Instant at) =>
        BimIo.ImportGeometry(InterchangeFormat.Glb, glb, clocks)
