...
flowchart LR
    ...
    accDescr: Interaction folds, version ghosts, and display postures all project onto one override state, which the viewpoint captures and the BCF seam exchanges.
