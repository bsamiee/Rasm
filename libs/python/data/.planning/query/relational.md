...
- Growth: a new query frontend is one `QuerySpec` case (the Ibis IR and the ADBC/ConnectorX remote transport land here); a new relational verb composes on the existing chain; zero new surface.
