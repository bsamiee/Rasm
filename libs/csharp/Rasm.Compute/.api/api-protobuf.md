...
- package: `Google.Protobuf` (version 3.35.1, direct pin)
...
- transitive floor: bound transitively by `Google.OrTools` (`MPModelProto` carriers) and `NodaTime.Serialization.Protobuf`; the central pin 3.35.1 wins the version-conflict resolution
