...
- For dirty-tree target work, clean changed files with `uv run python -m tools.quality static fix`, prove compile/analyzer state with `uv run python -m tools.quality static build`, and use bridge scenarios for GH runtime behavior.
