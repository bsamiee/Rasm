...
- `@effect/vitest` — the dev-plane spec runner binding the `@rasm/ts-testkit` law combinators (`tests/typescript/_testkit`) to every folder's colocated specs; catalogued at the dev-tool tier, `tests/typescript/.api/`.
