...
- Reject: a re-tabling of the registered singleton algebra, control and window construction (`libs/csharp/Rasm.Rhino/.api/api-eto-forms.md`), custom painting (`libs/csharp/Rasm.Rhino/.api/api-eto-drawing.md`), document output (`libs/csharp/.api/api-eto-printing.md`), platform selection and native hosting (`libs/csharp/Rasm.Rhino/.api/api-eto-platform.md`), and leaking the application singleton or a stringy MIME key past the owning rail
