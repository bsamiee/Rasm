...
const program = (adopt: boolean): Effect.Effect<Record.ReadonlyRecord<string, unknown>> =>
    Effect.sync(() => {
        ...
        return {
            ...
            securityUpdates: new RepositoryDependabotSecurityUpdates(`${_REPOSITORY.name}-security-updates`, { repository: repository.name, enabled: true }, { dependsOn: vulnerabilityAlerts })
                .enabled,
            rulesets: [
