# [@nats-io/kv] — the JetStream-materialized KV row: revision-CAS state, watch/history replay, tombstone-vs-purge
...
- module format: ESM + CJS dual; a distinct member of the v3 modular family — depends on `@nats-io/jetstream` + `@nats-io/nats-core`, both already admitted
