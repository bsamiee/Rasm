...
- `api-nodatime`(`libs/csharp/.api/api-nodatime.md`): this codec reads and writes that temporal object model, and the branch instant type it carries is the one every persisted timestamp resolves to.
