...
{
    public class TentedArch : RhinoArchBase
    {
        public static TentedArch Build(Point3d startPt, Point3d endPt, Vector3d normal)
        {
            //startPt = new Point3d(0, 0, 0);
            //endPt = new Point3d(10, 0, 0);
            //apexPoint = new Point3d(5, 10, 0);
            var partResult = ArcGeometry.Get_TentedArchArcs(startPt, endPt,
                 normal);
