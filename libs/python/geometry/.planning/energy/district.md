...
class District(Struct, frozen=True):
    ...
    def _gated(cls, graph: "DistrictGraph") -> Self:
        ...
        return cls(graph=graph, content_key=ContentIdentity.of("district", msgjson.Encoder(order="deterministic").encode(graph.to_dict())))
