...
Interpreter-floor resolvability is a machine fact the Forge build lane and python-overlay decide, never a PyPI wheel fact.
...
- `Dimension` closes the METRIC-attribute vocabulary alone — a span-only key homes at its stamping page, never in a view no instrument rows.
