...
- `[2]-[QUALITY]`: the data-quality gate over pandera, the recorded non-enforcing schema claim.
- `[3]-[ADMISSION]`: structural field shapes, narwhals frame admission, the contract route.
