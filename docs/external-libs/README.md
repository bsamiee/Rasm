...
|   [4]   | Host SDK boundaries | RhinoCommon and GH2 native ownership vs MathNet projection.                                                      |
...
- Keep package/version truth in each library `api.md`; keep repo posture in `*/rasm.md` and host boundaries in `../host/*`.
