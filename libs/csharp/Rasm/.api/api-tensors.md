...
|  [03]   | `TensorShape`      | `System.Numerics.Tensors`        | carries rank and strides |
|  [04]   | `TensorMarshal`    | `System.Runtime.InteropServices` | bridges raw tensor refs  |
|  [05]   | `TensorPrimitives` | `System.Numerics.Tensors`        | executes vectorized ops  |
