...
- note: `LasWriter` authors a LAS file — `Initialize` writes header+VLRs, `WritePoints` streams the body, the header composed through `LasHeaderBuilder`; the LAZ-compressed emit is the `libs/dotnet/.api/api-laszip.md` writer leg.
