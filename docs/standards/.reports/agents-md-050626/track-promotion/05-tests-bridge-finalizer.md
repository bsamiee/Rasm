...
Files read: `CLAUDE.md`, `docs/standards/README.md`, `docs/standards/AGENTS.md`, `docs/standards/agents-md.md`, `tests/csharp/AGENTS.md`, `tests/csharp/libs/AGENTS.md`, `tools/rhino-bridge/AGENTS.md`, `.reports/agents-md-050626/track-source-scans/12-tests-bridge-context.md`, `.reports/agents-md-050626/track-owner-routing/05-tests-bridge-refiner.md`, and `.reports/agents-md-050626/track-owner-routing/03-internalization-taxonomy.md`.
