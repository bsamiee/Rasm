...
- Packages: Eto.Forms for `Clipboard`, `DataObject`, `DragEffects` (verified in `libs/csharp/.api/api-eto-runtime.md` and `api-eto-forms.md`); LanguageExt.Core for the rails.
