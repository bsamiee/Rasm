...
- A synonym drifting through a file for one ranked or named vocabulary is a fork — repair every site to the canonical term; a domain term merely sharing the word stays.
- A gate WARN adjudicates by repair or by recording the posture that earns it.
- An article swap, determiner delete, or caps change on an explanatory sentence is a null repair — the frame survives under new words; the repair is re-authoring from the fact.
</calibration>
