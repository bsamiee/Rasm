...
public sealed partial class Dimension {
 ...
 static readonly FrozenDictionary<Dimension, string> SiSymbols = new Dictionary<Dimension, string> {
  ...
  [ThermalTransmittanceDim] = "W/(m2.K)",
 }.ToFrozenDictionary();
