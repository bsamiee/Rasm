...
- Output: `CurveSkeleton`, the result and wire consumed by Fabrication; the live contraction arena never crosses the boundary.
...
flowchart LR
    ...
    QuikGraph -->|skeleton topology and evidence| CurveSkeleton
