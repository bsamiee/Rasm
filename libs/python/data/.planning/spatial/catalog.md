    ...
    def over(self, target: FoldTarget) -> "RuntimeRail[StacDiscovery]":
        ...
        match target:
            case FoldTarget(tag="egress", egress=(egress, windows)):
                ...
                return traversed(rails, by=Disposition.ABORT).map(
