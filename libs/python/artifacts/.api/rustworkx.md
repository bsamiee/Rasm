...
- artifacts reaches rustworkx for BUILD, LAYOUT, DAG-ORDER, and the content-key WIRE only; the graph-ANALYSIS suite is the `data/graph/graph#GRAPH` owner's and a second analysis kernel here is the deleted form.
