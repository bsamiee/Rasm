...
- Packages: Rasm.Element (the seam `Environmental`/`LifecycleStage`/`MeasurementBasis`/`GeometryMeasures`), Rasm.Bim (the `Semantics/properties#BASE_QUANTITIES` `Decompose` takeoff), LanguageExt.Core, Rasm.
