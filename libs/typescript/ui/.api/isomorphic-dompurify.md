# [isomorphic-dompurify] — SSR-safe DOMPurify sanitize gate for every HTML-bearing content row
...
- version: `3.18.0`
- license: `MIT`
- deps: `dompurify ^3.4.11` (the sanitizer + full re-exported type surface), `jsdom ^29` (node `WindowLike` backing)
