...
- [06]-[KMS_CUSTODY]: KMS-signed authorship, DEK-envelope `EnvelopeKeyring` (`Mint`/`MintSealed`/`Unwrap`/`Rewrap`/`Probe`), and one `KeyCustody` attestation-and-DEK-envelope fold over `CustodyVerdict`.
...
// --- [OPERATIONS] ----------------------------------------------------------------------
public static class KeyCustody {
