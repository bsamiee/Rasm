...
- [FACE_SELECTION]-[OPEN]: does `cad.v1` need a `FaceSelection` beside `EdgeSelection` for face-scoped features and shelling; verify against `tests/contracts/proto/rasm/contracts/cad/v1/operations.proto` and the wire-contract law.
