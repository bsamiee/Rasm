...
public sealed partial class PostDialect {
    public static readonly PostDialect LinuxCnc = new("linuxcnc", PostFamily.WordAddress, CycleGrammar.SingleBlock, MacroGrammar.None,
        SubprogramGrammar.Label, new WcsRoster(6, 3), cutterComp: true, ArcMode.Both, blockCap: 0, decimals: 4, modal: true, Map(("thread-cycle", "G76")));
    public static readonly PostDialect Grbl = new("grbl", PostFamily.WordAddress, CycleGrammar.Expanded, MacroGrammar.None,
        SubprogramGrammar.None, new WcsRoster(6, 0), cutterComp: false, ArcMode.Both, blockCap: 0, decimals: 3, modal: true, default);
    public static readonly PostDialect Fanuc = new("fanuc", PostFamily.WordAddress, CycleGrammar.SingleBlock, MacroGrammar.MacroB,
        SubprogramGrammar.M98, new WcsRoster(6, 48), cutterComp: true, ArcMode.Both, blockCap: 0, decimals: 3, modal: true, Map(("thread-cycle", "G76")));
    public static readonly PostDialect Haas = new("haas", PostFamily.WordAddress, CycleGrammar.SingleBlock, MacroGrammar.MacroB,
        SubprogramGrammar.M98, new WcsRoster(6, 99), cutterComp: true, ArcMode.Both, blockCap: 0, decimals: 4, modal: true, Map(("thread-cycle", "G76")));
    public static readonly PostDialect Mazak = new("mazak", PostFamily.WordAddress, CycleGrammar.SingleBlock, MacroGrammar.MacroB,
        SubprogramGrammar.M98, new WcsRoster(6, 48), cutterComp: true, ArcMode.Both, blockCap: 0, decimals: 4, modal: true, default);
    public static readonly PostDialect Hypertherm = new("hypertherm", PostFamily.WordAddress, CycleGrammar.Expanded, MacroGrammar.None,
        SubprogramGrammar.M98, new WcsRoster(1, 0), cutterComp: true, ArcMode.Ijk, blockCap: 0, decimals: 4, modal: true, default);
    public static readonly PostDialect Siemens840D = new("siemens-840d", PostFamily.WordAddress, CycleGrammar.DialectCycle, MacroGrammar.RParam,
        SubprogramGrammar.Label, new WcsRoster(4, 95), cutterComp: true, ArcMode.Both, blockCap: 0, decimals: 3, modal: true, default);
    public static readonly PostDialect HeidenhainTnc = new("heidenhain-tnc", PostFamily.Conversational, CycleGrammar.DialectCycle, MacroGrammar.QParam,
        SubprogramGrammar.Label, new WcsRoster(0, 99), cutterComp: true, ArcMode.Ijk, blockCap: 0, decimals: 3, modal: false, default);
    public static readonly PostDialect OkumaOsp = new("okuma-osp", PostFamily.Conversational, CycleGrammar.DialectCycle, MacroGrammar.UserTask,
        SubprogramGrammar.Label, new WcsRoster(6, 50), cutterComp: true, ArcMode.Both, blockCap: 0, decimals: 4, modal: true, default);
    public static readonly PostDialect Fagor = new("fagor", PostFamily.WordAddress, CycleGrammar.SingleBlock, MacroGrammar.RParam,
        SubprogramGrammar.Label, new WcsRoster(6, 20), cutterComp: true, ArcMode.Both, blockCap: 0, decimals: 4, modal: true, default);
    public static readonly PostDialect Centroid = new("centroid", PostFamily.WordAddress, CycleGrammar.SingleBlock, MacroGrammar.MacroB,
        SubprogramGrammar.M98, new WcsRoster(6, 12), cutterComp: true, ArcMode.Both, blockCap: 0, decimals: 4, modal: true, default);
    public static readonly PostDialect Marlin = new("marlin", PostFamily.AdditiveGcode, CycleGrammar.Expanded, MacroGrammar.None,
        SubprogramGrammar.None, new WcsRoster(0, 0), cutterComp: false, ArcMode.Both, blockCap: 0, decimals: 3, modal: true, default);
    public static readonly PostDialect Reprap = new("reprap", PostFamily.AdditiveGcode, CycleGrammar.Expanded, MacroGrammar.None,
        SubprogramGrammar.None, new WcsRoster(6, 3), cutterComp: false, ArcMode.Both, blockCap: 0, decimals: 3, modal: true, default);
    ...
    public bool Admits(ProcessModality modality) =>
        Family == PostFamily.AdditiveGcode ? modality == ProcessModality.Additive : modality != ProcessModality.Additive;
...
public static class ProcessFamily {
    public static Fin<ProcessKind> Admit(ReadOnlySpan<char> key) =>
        ProcessKind.Validate(key, null, out var p) is { } f
            ? Fin.Fail<ProcessKind>(GeometryFault.DegenerateInput($"process:{f.Message}").ToError())
            : Fin.Succ(p!);
    ...
    public static Fin<(ProcessKind Process, Machine Machine)> AdmitPair(ReadOnlySpan<char> processKey, ReadOnlySpan<char> machineKey) =>
        Admit(processKey).Bind(p =>
            AdmitMachine(machineKey).Bind(m =>
                m.Admits(p)
                    ? Fin.Succ((p, m))
                    : Fin.Fail<(ProcessKind, Machine)>(GeometryFault.DegenerateInput($"process-machine:{m.Key} rejects {p.Key}").ToError())));
}
```
