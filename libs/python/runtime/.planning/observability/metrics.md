...
One cluster: `[2]-[METRIC]` — the installed-meter read, the observable instrument set, the drain-counter and process-gauge callbacks, the request-duration histogram.
