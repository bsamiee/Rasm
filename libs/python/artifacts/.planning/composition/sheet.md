...
class Sheet(Struct, frozen=True):
    ...
    async def _folded(self) -> Composed:
        held = await self.lane.offload(Kernel.of(_composed, KernelTrait.HOSTILE), self.op)
        return held.default_with(_sheet_raise)
