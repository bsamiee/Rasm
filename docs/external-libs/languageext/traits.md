...
>**Dictum:** *Traits make one algorithm honest across computation shapes.*
...
---
## [1][CORE]
>**Dictum:** *`K<F,A>` carries an effect without choosing the effect.*
...
---
## [2][CONSTRAINTS]
>**Dictum:** *Constraints describe the exact algebra an algorithm uses.*
...
---
## [3][TRANSFORMERS]
>**Dictum:** *Transformers avoid manual unwrapping when nested effects are the model.*
...
---
## [4][DOMAIN_TRAITS]
>**Dictum:** *Domain traits add algebra to value atoms only when the algebra matters.*
...
---
## [5][RULES]
>**Dictum:** *Advanced abstraction must buy compression.*
