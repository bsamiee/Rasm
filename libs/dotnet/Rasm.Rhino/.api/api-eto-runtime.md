...
- The registered `UITimer` is the portable pace this boundary falls back to; the macOS display-link pace supersedes it under the host gate (`libs/dotnet/Rasm.Rhino/.api/api-macos-native.md`).
