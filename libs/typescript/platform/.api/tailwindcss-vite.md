...
| :-----: | :-------------- | :------------- | :----------------------------- |
|   [1]   | `PluginOptions` | options object | controls CSS minification pass |
...
| :-----: | :--------- | :-------------------------------- | :------------------------------------------------------- |
|   [1]   | `optimize` | `boolean \| { minify?: boolean }` | Lightning CSS minification; `true` in build mode default |
...
| :-----: | :------------------- | :------------- | :--------------------------------- |
|   [1]   | `tailwindcss(opts?)` | plugin factory | default export; returns `Plugin[]` |
