# [DOTNET_TESTING_API_ARCHUNITNET]
...
[LOCAL_ADMISSION]:
- Architecture rules live in `tests/dotnet/_architecture` over the host-free closure; host-closed assemblies stay manifest facts, never loaded types.
