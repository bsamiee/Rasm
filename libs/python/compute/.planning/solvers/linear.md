...
class LinearIntent:
    ...
    async def solve(self, lane: LanePolicy) -> "RuntimeRail[SolverReceipt]":
        ...
        return await evidence_run(EvidenceScope.LINEAR, f"solve.{self.tag}", dispatch, facts={"route": self.tag})
