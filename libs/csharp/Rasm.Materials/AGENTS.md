...
- Keep public usage small and typed. Consumers query through `BrickCatalog.Find(designation)` returning `Fin<Brick>`, or enumerate the `FrozenDictionary` statics directly with LINQ.
