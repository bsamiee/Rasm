...
_TRACER: Final = trace.get_tracer("rasm.data.tabular.profile")
    ...
    async def interrogate(
        ...
        with _TRACER.start_as_current_span(
            ...
            return interrogated.bind(
                lambda plan: self.fingerprint(sampling).map(lambda key: ProfileReceipt.of(self.label, plan, data, len(self.steps), key))
            )
