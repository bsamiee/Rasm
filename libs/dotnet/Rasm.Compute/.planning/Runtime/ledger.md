...
- [02]-[COST_ALGEBRA]: `CostVector` — the decomposed per-axis cost monoid and its billing diff surface.
...
- Packages: Generator.Equals (`[Equatable]` + `[PrecisionEquality]` — the billing diff surface), BCL inbox
