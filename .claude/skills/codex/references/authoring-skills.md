...
- [ESTATE]: Estate codex skills live in `~/.codex/skills` as ports of the Claude-side Forge masters — same body, Claude-only frontmatter stripped, `agents/openai.yaml` added where app-surface metadata or invocation policy earns it.
