...
from tests._aspect import register_law  # noqa: PLC2701  # `_`-prefixed by S1 test-internal design
from tests._spec import assert_error, assert_ok, validity_matrix, ValidityCase  # noqa: PLC2701  # `_`-prefixed by S1 test-internal design
from tests._strategies import resolve  # noqa: PLC2701  # `_`-prefixed by S1 test-internal design
...
from tools.assay.rails.code import (
    _ag_normalize,  # noqa: PLC2701  # private primitives under direct law coverage
    _apply_report,  # noqa: PLC2701  # private primitives under direct law coverage
    _artifact,  # noqa: PLC2701  # private primitives under direct law coverage
    _checks,  # noqa: PLC2701  # private primitives under direct law coverage
    _dispatch,  # noqa: PLC2701  # private primitives under direct law coverage
    _languages,  # noqa: PLC2701  # private primitives under direct law coverage
    _rg_rows,  # noqa: PLC2701  # private primitives under direct law coverage
    _rg_status,  # noqa: PLC2701  # private primitives under direct law coverage
    _targets,  # noqa: PLC2701  # private primitives under direct law coverage
    _ts_language,  # noqa: PLC2701  # private primitives under direct law coverage
    _ts_rows,  # noqa: PLC2701  # private primitives under direct law coverage
    _ts_thunk,  # noqa: PLC2701  # private primitives under direct law coverage
    CodeParams,
    query,
    rewrite,
    search,
