...
- [01]-[ATOM_BINDING]: the sanctioned `@effect-atom` hooks, the native state constructors (`Atom.searchParam`, `Atom.kvs`, `Atom.family`, `Atom.pull`, `Atom.runtime`), and the `UndoStack` history fold.
