...
- Entry: `public Fin<TilePlan> Validate(...)` through the generated `[ComplexValueObject]` factory boundary — the one place the fixed-bucket law is spelled, composed at `Model/stage#STAGE_WIRE` `StageRequest.Plan` and nowhere else.
