...
|  [03]   | `generate`                        | `generate(name, code, writer=None, output, writer_options=None, text=None) -> str \| None` |
|  [04]   | `PROVIDED_BARCODES`               | sorted `list[str]` (22 keys, 13 classes)                                                   |
...
| :-----: | :------------------------ | :----------------------------------------------- | :------------------------------------------------------- |
|  [01]   | `Barcode.render`          | `render(writer_options=None, text=None)`         | in-memory SVG `str`/`PIL.Image`; reads bytes via `write` |
