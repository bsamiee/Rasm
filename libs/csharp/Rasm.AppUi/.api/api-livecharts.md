...
| :-----: | :------------------------ | :-------------------------------------- | :----------------------------- |
|  [01]   | `CartesianChart`          | `…Avalonia` (: `SourceGenCartesianChart`) | Cartesian chart                |
|  [02]   | `PieChart`                | `…Avalonia` (: `SourceGenPieChart`)     | pie chart                      |
|  [03]   | `PolarChart`              | `…Avalonia` (: `SourceGenPolarChart`)   | polar chart                    |
|  [04]   | `GeoMap`                  | `…Avalonia` (: `SourceGenMapChart`)     | map chart                      |
|  [05]   | `MotionCanvas`            | `…Avalonia` (: `UserControl`)           | raw Skia drawing canvas        |
|  [06]   | `SourceGenChart`          | `LiveChartsGeneratedCode`               | abstract generated base (`UserControl`, `IChartView`, `ICustomHitTest`) |
|  [07]   | `SourceGenCartesianChart` | `LiveChartsGeneratedCode`               | generated Cartesian base       |
|  [08]   | `SourceGenPieChart`       | `LiveChartsGeneratedCode`               | generated pie base             |
|  [09]   | `SourceGenPolarChart`     | `LiveChartsGeneratedCode`               | generated polar base           |
|  [10]   | `SourceGenMapChart`       | `LiveChartsGeneratedCode`               | generated map base (`IGeoMapView`) |
