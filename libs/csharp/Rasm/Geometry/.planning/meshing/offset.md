...
| :-----: | :-------------- | :------------ | :---------------------------------------------------------------------------------------------------- | :------------------------------------- | :-----: |
|  [01]   | Offsetting      | `OffsetOp`    | `[Union]` (`Skeleton`/`Medial`/`Minkowski`/`Offset`/`Weighted`) over one `WavefrontStore` + `Apply`   | `Offsetting.Apply → Fin<OffsetResult>` |    5    |
