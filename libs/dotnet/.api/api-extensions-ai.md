...
- `Microsoft.Extensions.AI`(`Rasm.AppHost/.api/api-extensions-ai-middleware.md`): `ChatClientBuilder` and `EmbeddingGeneratorBuilder` decorate and build the injected contracts, holding the abstraction-to-concrete split at the DI boundary.
