...
- Sibling-consumer drift: sibling folders composing one stratum owner through divergent spellings, partial surfaces, or local wrappings — demand one composed form, the divergence named at both sites.
...
Settled strata outrank intuition: a composition the owning strata row rules is never a finding. A pass that finds nothing after walking every touched folder's stratum row states that verdict plainly.
