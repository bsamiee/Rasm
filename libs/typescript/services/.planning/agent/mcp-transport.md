...
// ToolResultWire decodes the producer single mint at mcp-projection#TS_PROJECTION
...
flowchart LR
  ...
  catalog -->|Toolkit| agent[agent-runtime DurableAgent]
