...
- [1]-[DOCUMENT]: document-mode dispatch axis whose backend-per-mode policy rows lower from `DocumentNode`, carrying the Typst introspection-and-data-bind rows on the held `Compiler` world.
