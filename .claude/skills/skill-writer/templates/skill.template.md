...
name: <skill-token>
description: >-
    <deliverable-claim-total-first-clause>: <discriminating-objects-verbs-file-kinds>. Use when
    <quoted-utterances-the-task-arrives-wearing>. <refused-adjacent-deliverable> belongs to the
    <owning-sibling> skill.
---
...
[REFERENCES]:
- [NN]-[<TOKEN>](references/<file>.md): <doctrine the branch opens it for; the task that routes here>
...
<the deterministic gate invocation that binds completion over every touched artifact, with its exit-code contract>
