...
public sealed partial class ConeProjection {
    ...
    // Beam radius per unit axis distance — the spotlight/beam consumer's radius-at-distance scalar
    // (radius = distance · Spread); inline tan(halfAngle) trig at a light or capture boundary is
    // the hand-roll this row deletes.
