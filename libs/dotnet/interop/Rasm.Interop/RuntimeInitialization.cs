...
/// <remarks>
/// <para>Repeated calls are harmless, and no library poisons state when it fails before initialization: retry after a late <see cref="Initialize"/> succeeds</para>
...
/// BrowserFetcherOptions.Path with a pinned browser build; FFmpeg needs ffmpeg.RootPath on legacy FFmpeg.AutoGen facade and DynamicallyLoadedBindings.Initialize() on modern Abstractions facade</para>
