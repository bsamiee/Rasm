...
- Packages: Grasshopper2 (`SnappingConstraints`, `SnappingSettings`, `SnapSpace`, `StretchLayoutSolver`), LanguageExt.Core (`Validation`), `Rasm.Domain` (`CapabilitySet`, `CapabilityLaw`).
