...
|  [09]   | `TensorStore.getitem`                        | `store[transform \| domain \| expr \| indices]` -> `TensorStore`                                                                                                      | virtual view by transform/domain/expr/NumPy indexing |
|  [10]   | `TensorStore.setitem`                        | `store[transform \| domain \| expr \| indices] = source`                                                                                                              | synchronous write into the indexed sub-view          |
...
|  [18]   | `TensorStore.array`                          | `array(dtype=None)` -> `numpy.ndarray`                                                                                                                                | synchronous NumPy interop conversion                 |
...
|  [03]   | `Future.await`             | `await future` -> `T`                                                                         | async-native consumption of the result      |
