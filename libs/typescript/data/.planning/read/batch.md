...
const _family = Fault.Class.family(["archived", "owner", "integrity", "io"] as const, {
  ...
  owner: Fault.Class.row({
    ...
    leg: "descriptor",
    detail: _Subject,
    render: ({ key, detail }) => `${key} carries a custody coordinate the store boundary refuses — ${detail}`,
  }),
