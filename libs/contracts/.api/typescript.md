...
- module: `./*` to `./gen/typescript/*.ts` in the workspace and to `./dist/*` declarations and ESM in the tarball
...
|  [02]   | `WatchResponseSchema`    | message | public-root     | `WatchResponse`         |
|  [03]   | `WatchRequestSchema`     | message | public-root     | `WatchRequest`          |
|  [04]   | `ProgressPhaseSchema`    | enum    | support-closure | `ProgressPhase`         |
|  [05]   | `ProgressService`        | service | support-closure | `ProgressService`       |
|  [06]   | `ProgressService.Watch`  | method  | public-root     | `ProgressService.Watch` |
...
|  [11]   | `WriteOutcomeWireSchema`            | message | public-root     | `WriteOutcomeWire`            |
...
|  [06]   | `DeckOutcomeWireSchema`               | message | support-closure | `DeckOutcomeWire`               |
...
|  [83]   | `EvidenceWireSchema`                  | message | public-root     | `EvidenceWire`                  |
|  [84]   | `EvidenceWire_SurfaceSchema`          | message | support-closure | `EvidenceWire.Surface`          |
|  [85]   | `EvidenceWire_FocusSchema`            | message | support-closure | `EvidenceWire.Focus`            |
|  [86]   | `EvidenceWire_RenderSchema`           | message | support-closure | `EvidenceWire.Render`           |
|  [87]   | `EvidenceWire_DisposalSchema`         | message | support-closure | `EvidenceWire.Disposal`         |
|  [88]   | `EvidenceWire_EditSchema`             | message | support-closure | `EvidenceWire.Edit`             |
|  [89]   | `EvidenceWire_ThemeSchema`            | message | support-closure | `EvidenceWire.Theme`            |
|  [90]   | `EvidenceWire_MotionSchema`           | message | support-closure | `EvidenceWire.Motion`           |
|  [91]   | `EvidenceWire_EffectSchema`           | message | support-closure | `EvidenceWire.Effect`           |
|  [92]   | `EvidenceWire_Effect_ExtentSchema`    | message | support-closure | `EvidenceWire.Effect.Extent`    |
|  [93]   | `EvidenceWire_AssetSchema`            | message | support-closure | `EvidenceWire.Asset`            |
|  [94]   | `EvidenceWire_LiveDataSchema`         | message | support-closure | `EvidenceWire.LiveData`         |
|  [95]   | `EvidenceWire_CollabSyncSchema`       | message | support-closure | `EvidenceWire.CollabSync`       |
|  [96]   | `EvidenceWire_CollabRevertSchema`     | message | support-closure | `EvidenceWire.CollabRevert`     |
|  [97]   | `EvidenceWire_MediaSchema`            | message | support-closure | `EvidenceWire.Media`            |
|  [98]   | `EvidenceWire_QualitySchema`          | message | support-closure | `EvidenceWire.Quality`          |
|  [99]   | `EvidenceWire_GpuFrameSchema`         | message | support-closure | `EvidenceWire.GpuFrame`         |
|  [100]  | `EvidenceWire_LayoutSchema`           | message | support-closure | `EvidenceWire.Layout`           |
|  [101]  | `EvidenceWire_DispatcherLagSchema`    | message | support-closure | `EvidenceWire.DispatcherLag`    |
|  [102]  | `EvidenceWire_PreCommitSchema`        | message | support-closure | `EvidenceWire.PreCommit`        |
...
| :-----: | :---------------- | :------------ | :-------------------------------------------------------------------- |
|  [01]   | `CloudEventsAvro` | readonly-json | `libs/contracts/gen/typescript/io/cloudevents/v1/cloudevents_avro.ts` |
...
[TOPOLOGY]:
- `libs/contracts/RULINGS.md` `[02]-[SHAPE]` owns the `./*` export, valid-type option, and publisher-descriptor seat; `[04]-[STRUCTURE]` the sweep.
- `gen/typescript/` is the out root: one `<proto path>_pb.ts` module per source the closure reaches, `cloudevents_avro.ts` projected beside it.
...
[STACKING]:
- `@bufbuild/protobuf`(`../../typescript/.api/bufbuild-protobuf.md`): `<Name>Schema` drives create, decode, encode, equality, and validation.
