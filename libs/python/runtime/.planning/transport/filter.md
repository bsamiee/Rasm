...
- Receipt: accumulated faults ride the emitter's own delivery receipt beside the withheld count at `transport/binding#EMISSION`, so an expression quietly erroring on every event reads as a rate rather than as silence; this owner mints none.
