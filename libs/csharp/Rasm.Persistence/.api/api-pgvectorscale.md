...
| :-----: | :------------------ | :--------- | :------------------ | :---------------- |
|  [01]   | `vector_cosine_ops` | `<=>`      | cosine              | `CosineDistance`  |
|  [02]   | `vector_l2_ops`     | `<->`      | L2 / euclidean      | `L2Distance`      |
|  [03]   | `vector_ip_ops`     | `<#>`      | negative inner-prod | `MaxInnerProduct` |
...
| :-----: | :----------------------- | :------ | :----------------- | :--------------------------------------------------------------- |
|  [01]   | `storage_layout`         | text    | `memory_optimized` | `memory_optimized` enables SBQ; `plain` stores full vectors      |
|  [02]   | `num_neighbors`          | integer | `50`               | graph degree; `-1` derives degree from dimensionality            |
|  [03]   | `search_list_size`       | integer | `100`              | build-time candidate-list breadth                                |
|  [04]   | `max_alpha`              | double  | `1.2`              | graph density / pruning aggression                               |
|  [05]   | `num_dimensions`         | integer | `0`                | dimensions to index; `0` indexes all                             |
|  [06]   | `num_bits_per_dimension` | integer | `0`                | SBQ bits/dim; `0` auto-selects (2 below 900 dims, 1 at or above) |
