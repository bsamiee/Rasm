...
test.describe('visual gauge', () => {
    test('the deterministic panel matches its committed golden', async ({ hermetic, page }) => {
...
test.describe('aria gauge', () => {
    test('the intake form matches its aria contract', async ({ hermetic, page }) => {
    ...
    test('a wrong accessible name refutes the aria contract', async ({ hermetic, page }) => {
        await hermetic.open('/form');
