...
flowchart LR
    ...
    PlanN -->|TreeNode graph → Lattice beams| Implicit["Additive/implicit (QUEUED row 25)"]
    PlanN -->|overhang census| Production["Additive/production (QUEUED row 26)"]
```
