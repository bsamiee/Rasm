...
Scenario.Run("nb-blocks", CAPTURE_PATH, (key, facts) => {
    string root;
    ...
    string[] expected = new[] { "CoreRail", "Stats", "GraphPlan", "Author", "Bounds", "WriteAttributes", "ArchiveClosure", "ArchiveValidateBroken", "NativeAdd", "PlacementReference" };
    RunCorpus(root, "tests/csharp/libs/Rasm.Rhino.Scenarios/bin/Release/net10.0/Rasm.Rhino.Scenarios.dll", expected, facts);
});
