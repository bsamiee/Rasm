...
| :-----: | :---------------- | :-------------------------------------------------------------------------------------------- | :----------------------- |
|  [01]   | `ClassValue`      | `ClassArray \| ClassDictionary \| string \| number \| bigint \| null \| boolean \| undefined` | recursive accepted input |
|  [02]   | `ClassDictionary` | `Record<string, any>`                                                                         | truthy-key object form   |
|  [03]   | `ClassArray`      | `ClassValue[]`                                                                                | nested array form        |
...
| :-----: | :-------------------------------------- | :---------- | :--------------------------------------------- |
|  [01]   | `clsx(...inputs: ClassValue[]): string` | `clsx`      | recursive join over strings, arrays, objects   |
|  [02]   | `export default clsx`                   | `clsx`      | ESM default joiner binding                     |
|  [03]   | `module.exports.clsx`                   | `clsx`      | CJS named joiner alongside callable export     |
|  [04]   | `clsx(...inputs): string`               | `clsx/lite` | string-only join, no array or object recursion |
