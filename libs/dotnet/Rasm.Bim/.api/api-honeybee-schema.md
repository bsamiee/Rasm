...
- `System.IO.Hashing`(`libs/dotnet/.api/api-hashing.md`): a `Model.ToJson()` UTF-8 string feeds `XxHash3` for the fast fingerprint and `XxHash128` for the persisted content key, the same identity rail the IFC/glTF exports ride; an HBJSON document rides a `Speckle`(`libs/dotnet/.api/api-speckle.md`) commit or lands in the `Rasm.Persistence` artifact index keyed by that hash.
