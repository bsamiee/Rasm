...
// package owns AISC grades — the §4 "design codes hand-roll" caveat); the EN bands resolve EnSteelFactory through Delivery:
...
// cross-section FIELD: the canonical ComputedSection (the seventeen-field receipt every family shares), the SteelClass, the
...
// receipt ParametricSection produces for the rectangle families (component#COMPONENT_OWNER): ZxMm3/ZyMm3 the plastic moduli,
...
// iShape/uShape arms a prior flat dispatch carried.
...
// geometry) → the CANONICAL component#COMPONENT_OWNER ComputedSection (the seventeen-field receipt every family shares),
