...
- rail: 5d-costing
- `qto.RULE_SET` literal is the closed rule-set vocabulary: `IFC4QtoBaseQuantities`, `IFC4QtoBaseQuantitiesBlender`, `IFC4X3QtoBaseQuantities`, `IFC4X3QtoBaseQuantitiesBlender`.
