...
- `[2]-[MESH]`: mesh-file identity, cell-block topology, units, GLB preview export.
- `[3]-[POINTCLOUD]`: the LAS/LAZ/COPC point-cloud interchange row and the columnar point-record bridge.
