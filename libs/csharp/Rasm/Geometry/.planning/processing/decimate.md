...
public static class Simplification {
    ...
    static (Point3d Target, double Cost) OptimalPosition(Quadric q, Point3d u, Point3d v) {
        var lhs = DenseMatrix.OfArray(new double[,] {
            { (double)q.A00, (double)q.A01, (double)q.A02 },
            { (double)q.A01, (double)q.A11, (double)q.A12 },
            { (double)q.A02, (double)q.A12, (double)q.A22 } });
        var rhs = DenseVector.OfArray(new[] { (double)(-q.A03), (double)(-q.A13), (double)(-q.A23) });
