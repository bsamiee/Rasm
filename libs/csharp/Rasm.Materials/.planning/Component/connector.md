...
public sealed partial class ConnectorType {
    ...
    // Stone-cladding support and restraint: the shelf angle carries panel gravity on its horizontal leg (the kerf
    // bar or dowel pin engaging the panel edge rides fastener#FASTENER_FAMILY as the kerf/pin kinds), the restraint
    ...
    public bool CarriesMember { get; }        // true only for the seat-bearing forms — the saddle families and the stone support shelf
