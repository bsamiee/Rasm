...
- [1]-[CONFORM]: fonttools subset/instance, uharfbuzz text-shaping, pyhanko PAdES-signing, and pyhanko/pikepdf conformance-verification owner; `PositionedGlyphRun` and `ConformanceVerdict` are the two value-object sub-owners the shape and audit arms carry.
