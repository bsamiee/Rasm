...
A shape preserved because an old caller, persisted reader, or predecessor depends on it: old-reader guarantees, surviving fallbacks, retired engines and dead aliases narrated in owner law.

- Detection: A justification by an old reader's dependence, or a named predecessor, retired engine, or prior store.
...
- Reframe: A genuine persisted-wire pin is a positive property of the wire stated once at its codec owner; everything else has no predecessor to spare.
...
An impossibility claim — unspellable, structurally impossible, can never — whose clause does not name the enforcing structure: a victory lap standing in for the mechanism, unfalsifiable by a reader and unverifiable by a rebuild agent.
