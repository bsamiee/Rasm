...
import { streamPolicy } from "../../projection/fold-core/stream-policy.ts";
...
// agent/mcp-transport consumes), decoded to text and fed chunk-by-chunk into one Parser.
