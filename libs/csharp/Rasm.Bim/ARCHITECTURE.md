...
flowchart LR
    ...
    accDescr: Bim owners exchanging wires, shapes, ports, receipts, content keys, and boundaries with the cross-runtime peers, the app platform, and the host boundary.
    subgraph bim[RASM.BIM]
        Model[Object model]
        Semantics[Semantic enrichment]
        Exchange[Interchange codec]
