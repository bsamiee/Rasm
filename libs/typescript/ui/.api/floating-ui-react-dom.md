# [@floating-ui/react-dom] — DOM middleware layer under the floating-anchor rows
...
- package: `@floating-ui/react-dom` (2.1.8, MIT, © Floating UI contributors)
...
- peer: `react@>=16.8.0`, `react-dom@>=16.8.0`; dep `@floating-ui/dom@^1.7.6` (the framework-agnostic engine this package wraps)
