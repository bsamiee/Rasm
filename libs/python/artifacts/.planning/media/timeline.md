...
class Timeline(Struct, frozen=True):
    ...
    async def _emit(self) -> RuntimeResult[Produced]:
        held = await async_boundary(TIMELINE_FOLD, self._folded, catch=MEDIA_RESIDUE)
        settled = held.bind(
