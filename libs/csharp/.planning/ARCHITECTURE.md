...
├── Rasm.Bim/            # AEC-DOMAIN — host-neutral BIM object model + IFC/glTF/STEP exchange codec + element-set/classification/assembly + properties/validation/coordination/georeferencing + the planned reconstruction scan-to-BIM primitive-fit owner
