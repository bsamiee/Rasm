...
public sealed partial class VectorMetric {
    ...
    public static readonly VectorMetric Hamming = new("hamming", op: "<~>", bit: true);
    public static readonly VectorMetric Jaccard = new("jaccard", op: "<%>", bit: true);
