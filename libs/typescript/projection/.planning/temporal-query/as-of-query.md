...
import { dominates } from "../causality-graph/version-vector";
...
import { eventNanos } from "../standing-query/watermark";
import { dominates } from "../causality-graph/version-vector";
import type { Projection } from "../fold-core/projection";
...
flowchart LR
  ...
  coord -->|Stable| stable[stablePrefix → stability-frontier cursor meet]
  ...
  proj --> diff[as-of-diff two-coordinate diff]
```
