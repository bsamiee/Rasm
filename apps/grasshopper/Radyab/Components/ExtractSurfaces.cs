...
public sealed class ExtractSurfaces : Component {
    ...
    private static readonly IOutputGroup Faces = Output.Details<FaceProjection>(
        ...
        slots: [
            Output.Plain<FaceProjection, Brep>(port: Port.Tree<Brep>(name: "Faces", code: "F", info: "Every face as a trimmed single-face Brep."), project: static value => value.Brep),
            Output.Plain<FaceProjection, int>(port: Port.Tree<int>(name: "Face Index", code: "FX", info: "Source Brep face index aligned with each face."), project: static value => value.FaceIndex),
        ]);
    private static readonly IOutputGroup Top = Output.Single<Rasm.Analysis.Faces, Brep>(
    ...
    private static readonly IOutputGroup Bottom = Output.Single<Rasm.Analysis.Faces, Brep>(
    ...
    public ExtractSurfaces() : base(self: typeof(ExtractSurfaces), spec: ComponentSpec.Of(
        ...
        outputs: Seq<IOutputGroup>(Faces, Top, Bottom, Frame))) { }
}
