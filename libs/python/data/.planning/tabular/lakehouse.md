...
_VECTOR_INDEX: frozenset[str] = frozenset({"IVF_PQ", "IVF_HNSW_PQ", "IVF_HNSW_SQ"})
...
_READ_ONLY: frozenset[str] = frozenset({"read", "changefeed"})
...
_LANCE_MODE: dict[WriteMode, LanceMode] = {"error": "create", "ignore": "create", "overwrite": "overwrite", "append": "append"}
