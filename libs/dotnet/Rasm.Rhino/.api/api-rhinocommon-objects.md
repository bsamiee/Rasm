...
- `ObjectAttributes` re-declares the user-string roster `libs/dotnet/Rasm.Rhino/.api/api-rhinocommon-persistence.md` owns; the attribute store is independent of the geometry store on the same object.
