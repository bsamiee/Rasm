...
// Area extrema are BOTH directions of the Jacobian singular-value product: MaxArea observes expansion (> 1),
// MinArea observes compression (< 1) — a consumer bounding physical distortion gates both, since a uniformly
// compressed flip-free atlas is as unusable for cutting as a stretched one.
