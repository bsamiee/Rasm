...
public abstract partial record Fault : Expected {
    ...
    public sealed record MissingCustomUnitScale : Fault { public override string Message => "Rhino document custom model unit scale is required."; public override string Category => "Context"; }
