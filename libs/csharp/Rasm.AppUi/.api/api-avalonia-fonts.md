...
| :-----: | :---------------------- | :----------------------------------------------------------------- | :---------------------- | :---------------- |
|  [01]   | `WithInterFont`         | `static AppBuilder WithInterFont(this AppBuilder)`                  | `AppBuilderExtension`   | Inter admission   |
|  [02]   | `ConfigureFonts`        | `AppBuilder ConfigureFonts(this AppBuilder, Action<FontManager>)`  | `Avalonia.AppBuilderExtensions` (boundary) | font config |
|  [03]   | `AddFontCollection`     | `void AddFontCollection(IFontCollection)`                          | `FontManager` (boundary)| collection load   |
|  [04]   | `.ctor`                 | `InterFontCollection()`                                            | `InterFontCollection`   | family owner      |
