...
- `anyio`/`stamina`: `LanePolicy.offload(_composed, op, modality=Modality.THREAD, retry=RetryClass.OCCT)` owns capacity, retry, cancellation, and boundary-fault conversion for rendering and recovery.
