...
- [02]-[THERMAL_ENVELOPE]: `RunThermal` folds the ISO 6946 series-`U` with its EN ISO 13788 Glaser profile for an envelope, and the EN ISO 10077-1 `Uw` for a window.
