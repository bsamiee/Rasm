...
public static class Coordination {
    ...
    // its verdict announcement already join on, with the name carried in the title as name#ordinal for a reader. One
