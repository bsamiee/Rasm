...
public static class Acquisition {
    ...
    // the bsdf#MICROFACET_KERNEL the forward model — the Rasm.Compute/blas#DENSE_ALGEBRA dense-overdetermined route shape, never
    ...
    static Fin<BrdfFit> SolveGgx(Seq<BrdfSample> samples, double ior0, Op key) {
        ...
        for (int iter = 0; iter < 12; iter++) {
            ...
            // IsFullRank stays true (Rasm.Compute/blas#DENSE_ALGEBRA admission), so probe the solution all-finite and fall back to the
