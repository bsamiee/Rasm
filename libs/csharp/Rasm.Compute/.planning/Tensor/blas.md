...
- [01.1]-[LEVENBERG_MARQUARDT]: damped Gauss-Newton nonlinear least-squares; HyperJet the canonical exact-Jacobian provider.
- [01.2]-[SPECTRAL_LAW]: dense-symmetric/general spectral split; Schur-pair decode; eigen-filter weights.
