...
- `SharpGLTF.Ext.3DTiles`(`libs/csharp/.api/api-sharpgltf-3dtiles.md`): `GltfForwardTranslator` and `ThreeJSForwardTranslator` emit a model's geometry onto the Exchange/export delivery rail the glTF and 3D-Tiles legs share.
