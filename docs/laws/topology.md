...
- Obligates: Every planning fence citing the member, because fences prove spelling, accessibility, and arity.
...
- Law: Recorded behavioral traps — a fault on the estate's canonical input type, a lane or modality restriction — bind every composing fence to a structural close, never a prose acknowledgment.
