...
*                           →  typescript:runtime/serve                    # [WIRE]: support-capture verb
...
Wire/Livewire.cs            →  typescript:ui/viewer                        # [WIRE]: livewire triple BindingStatus/CoercedValue/WriteReceipt materialized at the panel plane
