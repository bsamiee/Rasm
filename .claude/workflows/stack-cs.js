export const meta = {
    name: 'stack-cs',
    description: 'Harden C# stack doctrine',
    phases: [
        {
            title: 'Inventory',
...
const CS_SUBSTRATE = [
    'STACK CAPABILITY, ULTRA-STACKED: enumerate BOTH `.api` tiers with a REAL ls/fd listing from disk, never memory — the central `libs/csharp/.api/` ' +
        ...
        'ONLY host/NuGet members confirmed via `uv run assay api` (verified-local beats any catalog line on ' +
...
const authorPrompt = (page) =>
    [
        ...
        'TASK: HOSTILE HARDEN of ' +
            ...
            'read-only rigor benchmark), the style-guide, and VERIFY every cited host/NuGet member via `uv run assay api` (assay blocked or ' +
