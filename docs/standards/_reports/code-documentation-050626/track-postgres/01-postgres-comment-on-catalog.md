...
[WORKTREE_CONTEXT]:
- `git status --short -- docs/standards/_reports/code-documentation-050626 docs/standards/reference/code-documentation.md docs/standards/README.md docs/standards/AGENTS.md` showed pre-existing `M docs/standards/reference/code-documentation.md` and several untracked sibling `_reports/` reports before this report write.
...
Write action:
- Created `docs/standards/_reports/code-documentation-050626/track-postgres/01-postgres-comment-on-catalog.md` only.

## [10][CLOSE_CHECK]

- [x] Assigned report file created at `docs/standards/_reports/code-documentation-050626/track-postgres/01-postgres-comment-on-catalog.md`.
