...
- Reject: a runtime descriptor walk standing in for the corpus emission; a `PROTO_VOCABULARY` row beside a generated class; a census that reads one direction.
