...
│   ├── linear.py           # LinearIntent — dense, sparse, and eigen solves; the C#-paired sparse exchange containers
...
│   └── model.py            # ModelAsset — classical-estimator validation, smoke inference, ONNX export, drift-envelope companion
...
flowchart LR
    ...
    Experiments e18@-->|"[WIRE]: GraduationEnvelope"| Compute
    Solvers e19@<-->|"[WIRE]: SparseExchange"| Compute
