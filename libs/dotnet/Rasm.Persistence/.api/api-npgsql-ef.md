...
- `api-npgsql`(`libs/dotnet/.api/api-npgsql.md`): the ADO codec under this provider — identity columns, query translation, and migrations share one `NpgsqlDataSource` surface.
