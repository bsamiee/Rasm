...
`pyogrio` API capture placeholder for `data`.
...
[RAIL_LAW]:
- Package: `pyogrio`
- Owns: vector file I/O
- Accept: pending decompile capture once a cp315 wheel admits `pyogrio`
