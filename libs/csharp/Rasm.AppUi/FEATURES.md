...
| [10] | Multi-format drawing emit — PDF (`SKDocument`) and SVG (`SKSvgCanvas`) ship today, DWG/DXF entity-writer probe-gated; delivers through the one `VisualDestination` | `DraftEmit` | drafting-sheets#DRAFT_EMIT |
