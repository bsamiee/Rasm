...
public static class ComponentCatalogue {
    ...
    static Fin<(ComponentId Id, Component Item)> ConnectorOf(ConnectorRow r, Context context, Op key) =>
        ...
        from item in Component.Of(ComponentFamily.Connector, r.Designation, new ComponentSection.Connector(section), Coring.None, Standard, section.CapacityKey, section.AppearanceId, key)
