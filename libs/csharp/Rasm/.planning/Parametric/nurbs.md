...
public abstract partial record NurbsForm {
    ...
    public sealed record Surface : NurbsForm {
        ...
        // 2-var Newton over the derivative grid under the G7 knobs, Try-trapped (G9).
        public Fin<(double U, double V)> ClosestParameter(Point3d probe, NurbsPolicy? policy = null);
