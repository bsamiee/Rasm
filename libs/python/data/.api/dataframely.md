...
|  [07]   | `FailureInfo.invalid`             | property `-> pl.DataFrame`                                                                                                              | the invalid rows of the input frame                 |
|  [08]   | `FailureInfo.details`             | property `-> pl.DataFrame`                                                                                                              | invalid rows + per-rule `valid`/`invalid`/`unknown` |
