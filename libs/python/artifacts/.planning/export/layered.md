...
def _channel(method: PsdCompression, /) -> PsdCompression:
    # capability-detection at the boundary (the `media/filtergraph#FILTERGRAPH` native-vs-substitute shape): probe the
