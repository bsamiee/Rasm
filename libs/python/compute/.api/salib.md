...
| :-----: | :------------------------------------------------------------------------------------------------------------------ | :------- | :------------------------ |
|  [01]   | `saltelli.sample(problem, N, calc_second_order=True, skip_values=None) -> ndarray`                                  | Saltelli | Sobol quasi-random sample |
|  [02]   | `sobol.sample(problem, N, *, calc_second_order=True, scramble=True, skip_values=0, seed=None)`                      | Sobol    | Sobol sequence sample     |
