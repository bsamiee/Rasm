...
- [03]-[DEC_CARRIERS]: `DiscreteCalculus` the frozen adjoint seam, `SpectralBasis`, and the assembly/harmonic census family `Meshing/dec` mints and `Rasm.Compute` consumes.
