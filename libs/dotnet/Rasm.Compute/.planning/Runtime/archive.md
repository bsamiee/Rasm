...
- Boundary: `Try.lift` admits every PureHDF throw as its original `Error`; typed archive refusals arise only from explicit shape, policy, and capacity decisions.
