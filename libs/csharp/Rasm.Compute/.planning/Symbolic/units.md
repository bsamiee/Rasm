...
- [NEXT_MAJOR]-[OPEN]: how the UnitsNet next-major `QuantityInfo`/`QuantityValue` reshape lands against the frozen `QuantityFamily` row record; staged-restore reshape check against the next-major UnitsNet surface before adoption.
