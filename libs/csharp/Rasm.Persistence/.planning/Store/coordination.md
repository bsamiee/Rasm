...
public abstract partial record CoordinationReceipt : IValidityEvidence {
    ...
    public sealed record Debited(HashMap<string, long> Balances, Instant At, CorrelationId Correlation, Duration Elapsed) : CoordinationReceipt;
