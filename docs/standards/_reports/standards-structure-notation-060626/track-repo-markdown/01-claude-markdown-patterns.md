...
Target owner: docs/standards/information-structure.md; docs/standards/formatting.md; docs/standards/agentic-documentation.md; docs/standards/proof.md
...
Owner: `agentic-documentation.md` for task-output contracts; `information-structure.md` for record shape; `_reports/AGENTS.md` for report-specific field order.
...
Owner: `formatting.md` glyph rules; `agentic-documentation.md` artifact separation.
...
Correction: Route angle-bracket placeholders to code-block/template intent rules, HTML comments to source-view notation, and provider prompt XML delimiter guidance to `agentic-documentation.md` only when a provider target requires it.
Owner: `agentic-documentation.md` provider behavior and artifact separation; `formatting.md` hidden comments; `information-structure.md` code-block intent labels.
...
Owner: `agentic-documentation.md` for machine-facing skill surface; `information-structure.md` for produced-document structure; `formatting.md` for headings.
