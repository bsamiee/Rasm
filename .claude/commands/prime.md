...
2. Read in parallel: `CLAUDE.md`, `Directory.Build.props`, `Directory.Packages.props`, `.editorconfig`, `Workspace.slnx`, `tools/quality/__main__.py`, `tools/cs-analyzer/Kernel/RuleCatalog.cs`.
