...
- [1]-[PRESENCE_OVERLAY]: the per-participant `Atom.family` presence cohort fusing the durable `PresenceRowWire` claim and the `CrdtField.EphemeralMap` beat, and the floating cursor/selection/frustum render surface.
