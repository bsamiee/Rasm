...
| :-----: | :------------------------------------------------------- | :---------- | :------------------------------------------------ |
|   [1]   | `csharp:Rasm.AppHost/Runtime/lifecycle`        | json-stj    | RuntimeFeed                                       |
|   [2]   | `csharp:Rasm.AppHost/Observability/health` | json-stj  | HealthStore                                       |
|   [3]   | `csharp:Rasm.AppHost/Observability/bundles`      | json-stj    | CommandGateway capture-support                    |
|   [4]   | `csharp:Rasm.AppHost/Runtime/ports`                | json-stj    | ReceiptEnvelopeCarrier                            |
|   [5]   | `csharp:Rasm.Persistence/Version/snapshots`               | messagepack | DecodeRail geometry row + SnapshotFeed            |
|   [6]   | `csharp:Rasm.Persistence/Sync/collaboration`             | messagepack | DecodeRail (crdt-op union) + ConflictPresenceStore |
|   [7]   | `csharp:Rasm.Compute/Runtime/channels`                      | proto       | WireClients + ArtifactFrameRail + FaultDetailRail |
|   [8]   | `csharp:Rasm.Compute/Runtime/progress`                  | proto       | ProgressStore                                     |
|   [9]   | `csharp:Rasm.Compute/Runtime/receipts`                  | json-stj    | ReceiptStore + BenchmarkRoute                     |
