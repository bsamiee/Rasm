...
|  [02]   | `barcode.writer.BaseWriter`  | writer base    | abstract renderer; `__init__(initialize, paint_module, paint_text, finish)` binds the four render callbacks    |
