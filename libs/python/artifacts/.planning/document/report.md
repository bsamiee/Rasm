...
async def _notebook_arm(plan: "ReportPlan") -> "ReportFact":
    ...
    output, resources = await to_thread.run_sync(_exported, spec, executed, limiter=_OFFLOAD)  # blocking nbconvert render off the loop
