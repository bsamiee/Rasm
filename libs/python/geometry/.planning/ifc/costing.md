...
- [1]-[LIFECYCLE]: the quantity, cost, schedule, patch, and diff lifecycle phases under one `LifecyclePhase`-discriminated owner folding the four IfcOpenShell ecosystem siblings.
