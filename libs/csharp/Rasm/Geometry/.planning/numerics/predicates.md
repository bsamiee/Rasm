...
| [INDEX] | [CLUSTER]         | [OWNS]                                                                                                                                                                                                |
| :-----: | :---------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   [1]   | ROBUST_PREDICATES | Closed `Predicate` family — Orient2D/Orient3D/InCircle/InSphere direct + OrientLPI/OrientTPI/InCircleLPI/InSphereTPI implicit-point — filter-then-exact two-stage adaptive evaluation returning an exact `Sign`               |
...
|   [2]   | Exact predicates            | `Predicate`      | static surface + `Orient2D`/`Orient3D`/`InCircle`/`InSphere` filter-then-exact + `OrientLPI`/`OrientTPI`/`InCircleLPI`/`InSphereTPI` implicit-point members | `Predicate.Orient2D → Sign` (pure, total, exact) |    8    |
