...
public static class ElementClassifier {
    ...
    static readonly Map<(PrimitiveShape Shape, IfcDomain Domain, FitOrientation Orientation), (IfcClass Class, string Predefined)> Table =
        Map(
            ...
            ((PrimitiveShape.Sphere,   IfcDomain.Architecture,   FitOrientation.Any),        (IfcClass.Proxy,               "ELEMENT")),
            ...
            ((PrimitiveShape.Freeform, IfcDomain.Architecture,   FitOrientation.Any),        (IfcClass.Proxy,               "ELEMENT")));
