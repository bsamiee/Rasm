...
- Tension: BLOCKED on a managed E57/LAS package-admission ruling — no admitted codec exists and the ecosystem survey (license, maintenance signal, net10 asset) has not run; hand-rolling the E57 XML+binary layout without that ruling is the forbidden alternative.
