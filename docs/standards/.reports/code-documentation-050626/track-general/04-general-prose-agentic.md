...
- Assigned output: `.reports/code-documentation-050626/track-general/04-general-prose-agentic.md`.
...
6. Checked current worktree state for the requested files with `git status --short -- .reports docs/standards/reference/code-documentation.md docs/standards/style-guide.md docs/standards/README.md docs/standards/AGENTS.md`.
...
9. Created only the assigned `.reports/` report path.
