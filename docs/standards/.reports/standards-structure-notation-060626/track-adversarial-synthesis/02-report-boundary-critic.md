...
Target owner: `.reports/standards-structure-notation-060626/track-synthesis/00-collective-task-list.md`; `.reports/standards-structure-notation-060626/README.md`; `.reports/AGENTS.md`
...
- `.reports/AGENTS.md:21-23`, `80`, `105`, `149`, and `158` reject phase, wave, worker-role, transcript, validation-boilerplate, and report-frame promotion.
...
Evidence:
- `.reports/AGENTS.md:84-95` defines report identity fields and does not include worker identity.
- `.reports/AGENTS.md:141-143` says promoted rules must name owner files and report paths, not report roles.
- `.reports/AGENTS.md:157-158` rejects worker roles, prompt wording, task narration, and fixed agent counts in active owners.
...
- `track-synthesis/00-collective-task-list.md:742-756` correctly scopes report-session whitespace proof to `.reports`.
...
Evidence:
- `.reports/AGENTS.md:9` says `.reports/` does not own validation gates.
- `.reports/AGENTS.md:97-105` allows `[PROOF_GAPS]` but forbids top-level `VALIDATION`.
...
Evidence:
- `.reports/AGENTS.md:121-125` says current repository source wins when it conflicts with a report and stale report findings need correction.
- `.reports/AGENTS.md:147-151` says reports that only preserve archive mechanics, validation boilerplate, or duplicated synthesis should be deleted or marked `DROPPED` after promotion.
...
Evidence:
- `.reports/AGENTS.md:97-103` lists the allowed report sections.
- `.reports/AGENTS.md:105` says to preserve source lists and proof gaps, but remove process narration.
- `.reports/AGENTS.md:141` says to promote rules, not report frames.
...
Issue: The task list correctly blocks broad ripple, but several owner-file rows name active standards plus `.claude` or `.reports/AGENTS.md` together. That can blur three surfaces: active documentation standards, report-lane mechanics, and prompt or skill assets.

Proposed correction:
- For `Promote source-scan record principles without prompt wave choreography`, route report-specific field order only to `.reports/AGENTS.md`.
...
- `.reports/AGENTS.md:157-158` rejects provider manuals, command gates, and report source material as active authority.
...
- `fd -t f . .reports/standards-structure-notation-060626 | sort`.
- `wc -l .reports/standards-structure-notation-060626/track-*/*.md .reports/standards-structure-notation-060626/README.md`.
