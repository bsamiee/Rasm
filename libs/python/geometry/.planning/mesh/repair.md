...
def to_manifold(
    mesh: trimesh.Trimesh,
) -> "manifold3d.Manifold":  # the PUBLIC uint32-ceiling Manifold build: repair is the chartered manifold3d owner, spatial/quality compose this kernel downward
    import manifold3d
