...
- `CLAUDE.md`, root `AGENTS.md`, `docs/standards/README.md`, `docs/standards/AGENTS.md`, and `docs/standards/_reports/AGENTS.md`.
...
- The target session folder appears to lack a session `README.md`; `_reports/AGENTS.md` treats that as an archive-maintenance gap when no manifest exists.
