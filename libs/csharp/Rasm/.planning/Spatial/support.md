    ...
    public static Fin<SupportSpace> Of(object? value, Op? key = null) {
        ...
        return value switch {
            VectorCloud.ClusterCase cluster =>
                ...
                from mass in CloudKernel.MassOf(cluster: cluster, key: op)
                select new SupportSpace(value: cluster, admits: (Normal: false, Tangent: false, Frame: false, Signed: false)),
