...
internal static class RuleCatalog {
    ...
    internal static readonly DiagnosticDescriptor CSP0739 = Err("CSP0739", "GuardableFinConditional", "Boolean Fin<T> gate manually constructs success/failure; use guard(condition, errorFactory) in query flow or guard(condition, error).ToFin() for Unit", "FunctionalDiscipline");
    ...
    internal static readonly DiagnosticDescriptor CSP0742 = Err("CSP0742", "ManualOpAdmissionGate", "Manual Fin<T> admission gate duplicates Op.AcceptValue/Accept for '{0}'; route native sentinel validity through op.AcceptValue(value: ...) or op.Accept(value: ...)", "FunctionalDiscipline");
    ...
    internal static ImmutableArray<DiagnosticDescriptor> All { get; } = ImmutableArray.Create(
        ...
        CSP0739, CSP0740, CSP0741, CSP0742, CSP0802);
}
