...
- Packages: `Rasm`/Vectors (`MeshSpace`, native `Mesh` topology — composed), `Rasm.GeometryCore.Numerics` (`Predicate`/`Sign` — the geometry-kernel exact-sign floor, composed), `Rasm.GeometryCore.Spatial` (`SpatialIndex` — self-intersection broad-phase, composed), Thinktecture.Runtime.Extensions, LanguageExt.Core, BCL inbox.
...
using Rasm.GeometryCore.Numerics;                                   // Predicate, Sign — the geometry-kernel exact-sign floor, composed never re-minted
using Rasm.GeometryCore.Spatial;                                    // SpatialIndex — self-intersection broad-phase, composed
using Rasm.Vectors;                                                 // MeshSpace, native Mesh topology, TopologyReceipt, VectorIntent — settled vocabulary
using Rhino.Geometry;
using Thinktecture;
using static LanguageExt.Prelude;

namespace Rasm.GeometryCore.Healing;
