...
public static class CustomVisuals {
    ...
    public static TelemetryContributorPort TelemetryRow(string version, string schemaUrl) =>
        AppUiTelemetry.Contribute(version, schemaUrl,
            ...
            new(LayoutInstrument, InstrumentKind.Distribution, "s", "custom-visual layout-fold duration", Buckets.InteractionSeconds));
