        ...
        Foreclosed(found).Match(
            ...
            None: () =>
              ...
              from transferred in IO.liftAsync(async () =>
                  await HostEdge.Captured(token, async execution => {
...
- Packages: Velopack, LanguageExt.Core, NodaTime, Thinktecture.Runtime.Extensions, Generator.Equals, Rasm (kernel `InstrumentSet`), BCL inbox
