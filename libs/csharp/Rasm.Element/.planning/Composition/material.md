...
public abstract partial class MaterialPropertySet {
 ...
 // --- [ADMISSION_SLOTS]
 // The MATERIAL-DOMAIN column combinators, seated here because their payloads are this page's own (a MeasureValue
