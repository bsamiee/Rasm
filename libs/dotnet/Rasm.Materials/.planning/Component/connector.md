...
public sealed partial class ConnectorType {
    ...
    public string IfcAccessoryType { get; }
...
public static class ConnectorDetail {
    ...
    static Fin<(PropertyName, PropertyValue)> PlateRow(ConnectorPlate plate) =>
        ...
        select (DetailSchema.ConnectorPlate, (PropertyValue)new PropertyValue.Complex("connector-plate", Map(
            (DetailSchema.SheetThickness, thickness),
            (DetailSchema.BendRadius, bend),
            (DetailSchema.HoleDiameter, hole),
            (DetailSchema.HolePitch, pitch),
            (DetailSchema.HoleCount, (PropertyValue)new PropertyValue.Text($"{plate.Stock.HoleCount}")),
            (DetailSchema.DevelopedWidth, footprint))));
