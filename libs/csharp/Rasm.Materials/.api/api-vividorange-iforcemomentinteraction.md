...
`VividOrange.IForceMomentInteraction` is verified-transitive through direct package `VividOrange.InteractionDiagram` and is the interface floor of the column biaxial capacity hull — the
