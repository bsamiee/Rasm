...
- Law: tracker cells carry zero authority — every ack table and frontier rebuilds by re-absorbing the op prefix from its journal, and a retention floor compacted past that prefix forecloses the rebuild rather than shortening it.
