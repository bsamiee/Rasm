...
|  [06]   | `optimizer.qualify(expr, *, schema) -> Expr`               | static   | normalize and qualify tables/columns; mandatory pre-step  |
...
|  [09]   | `diff(source, target, *, matchings) -> list[Edit]`         | static   | AST edit set between two trees                            |
