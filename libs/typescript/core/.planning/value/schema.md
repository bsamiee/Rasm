...
- Law: `Refined.OrdinalKey` is the C# smart-enum ordinal crossing — a non-negative int32 (`0..2147483647`); smart-enum member semantics stay with the minting vocabulary owner, and the floor carries only the ordinal identity decoded rows key on.
