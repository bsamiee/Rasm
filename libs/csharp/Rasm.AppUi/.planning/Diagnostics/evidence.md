...
public static class AppUiTelemetry {
    ...
    public static Fin<InstrumentSet> Mount(
        ...
        select InstrumentSet.Of(cells, (
            TelemetryIdentity.Metered(factory, Source, version,
