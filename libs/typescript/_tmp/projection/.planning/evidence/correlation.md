...
- [01]-[EVIDENCE_CORRELATION]: Owns `EvidenceProjection`, its receipt and evidence folds, and the content-keyed `byContentKey` correlation lookup.

## [02]-[EVIDENCE_CORRELATION]
