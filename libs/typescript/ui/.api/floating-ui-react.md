# [@floating-ui/react] — floating-anchor positioning rows for popover/tooltip/sheet composition
...
- package: `@floating-ui/react` (0.27.19, MIT, © Floating UI contributors)
...
- peer: `react@>=17.0.0`, `react-dom@>=17.0.0`; deps `@floating-ui/react-dom@^2.1.8`, `@floating-ui/utils@^0.2.11`, `tabbable@^6` (focus-order enumeration for `FloatingFocusManager`)
