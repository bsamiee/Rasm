...
- [01]-[SKEW_BAND]: Owns `SkewBandWire`, `SkewInterval`, the `skewInterval` confidence-interval derivation, and the `bandsOverlap` ordering predicate.
