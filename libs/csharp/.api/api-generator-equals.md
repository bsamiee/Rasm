...
- A multidimensional-array member under any equality attribute NREs the whole generator, surfacing as warning `CS8785` that only `TreatWarningsAsErrors` makes fatal — such a member takes `[IgnoreEquality]`.
