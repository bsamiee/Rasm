...
async def _collated(sheets: tuple[SheetRef, ...], record: TransmittalRecord, /) -> RuntimeRail[bytes]:
    async def kernel() -> bytes:
        return await to_thread.run_sync(_collate, sheets, record, limiter=_GATE)
