...
- [1]-[ASSEMBLY_FOLD]: the `LayoutRun` parameterized run, the `Layout` resolved placement stream, the station/elevation course fold, the `JointPolicy`, and the realized opening/corner/arch/pier/layer-buildup stages.
