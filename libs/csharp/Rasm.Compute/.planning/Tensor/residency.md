...
- Owner: `EncodedTensor` — the model-lane wrap of the kernel `Rasm.Geometry.Encoding.EncodedGeometry`; the per-`PackKind` `Wire` mapping is the canonical geometry-ML input vocabulary.
