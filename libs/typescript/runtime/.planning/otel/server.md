...
- Exemption: the acquire body is the platform-forced registration boundary — the global manager install, the `HostMetrics` start call, and the composed unload closure are the SDK's own imperative contract.
