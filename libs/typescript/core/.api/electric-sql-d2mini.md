# [@electric-sql/d2mini] — the minimal, time-free differential core: the same incremental operator algebra at its smallest surface for the browser in-memory fold

[PACKAGE_SURFACE]:
- package: `@electric-sql/d2mini` · version `0.1.8` · license `Apache-2.0`
