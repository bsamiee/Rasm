...
- Law: the generated message IS the wire vocabulary and C# is the baked/material producer. The `appearance.v1` sibling set — shared vocabulary, environment products, set document, and material model — is the frozen corpus shape; peers consume generated bindings and keep no mirror.
