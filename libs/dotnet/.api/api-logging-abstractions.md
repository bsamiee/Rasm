...
- `Microsoft.Extensions.Diagnostics.Testing`(`tests/dotnet/.api/diagnostics-testing.md`): `FakeLogger` implements `ILogger` and `IBufferedLogger`, folding every emission into `FakeLogCollector` records without a provider.
