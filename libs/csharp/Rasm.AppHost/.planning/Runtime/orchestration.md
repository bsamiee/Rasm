...
- [02]-[WORKFLOW_FAMILY]: The `WorkflowInstance` record and its accumulating plan admission, the five-case `StepKind` union, the per-step status ladder, the step-refusal triage vocabulary, and the wake-key vocabulary.
