...
using LanguageExt;
using Rasm.Vectors;                     // Dimension (the [03] discrete grip-ply/shear-plane carrier)
...
using SiDim = Rasm.Element.Dimension;   // the SI-dimension axis the detail-bag mints ride — aliased clear of the Rasm.Vectors discrete-count Dimension
