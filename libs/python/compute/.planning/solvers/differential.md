...
class DifferentialIntent:
    ...
    async def solve(self, lane: LanePolicy) -> "RuntimeRail[SolverReceipt]":
        ...
        # runtime Kernel crossing owner. This weave owns span, fence, and the `@receipted(REDACTION)` receipt harvest.
