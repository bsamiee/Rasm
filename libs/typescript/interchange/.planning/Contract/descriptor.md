...
- [1]-[DESCRIPTOR_GATE]: the verdict family, the surface-set classify fold, the dial-seam gate service, the declaration-order checksum.
- [2]-[TS_PROJECTION]: the C# `ContractDrift`/`ContractGuard.Surface` shape the TS classifier mirrors verbatim.
