...
[IMPORTANT] Use `coverlet.MTP` through the Microsoft Testing Platform runner where the project configures it. It belongs only in runnable test projects; testkit, benchmarks, fuzz harnesses, and runtime scenarios are not coverage targets.
