...
- Boundary: pointblank owns validation and grading, Narwhals owns frame normalization, and runtime owns identity and host seams. Domain logic records and grades without raising or re-interrogating a supplied `Interrogation`.
