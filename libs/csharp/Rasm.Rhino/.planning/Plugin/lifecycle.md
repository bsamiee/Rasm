...
- Entry: `RasmPlugIn.Root` publishes it once the load settled; `apps/rhino/<Plugin>/` reads it and binds the AppHost lacing that only that assembly may reference.
