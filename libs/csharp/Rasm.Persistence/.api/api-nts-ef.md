...
| :-----: | :---------------------------------------------------------- | :------------------- | :------------------------------------ |
|  [01]   | `NpgsqlNetTopologySuiteDbContextOptionsBuilderExtensions`   | builder extension    | admits plugin                         |
|  [02]   | `NpgsqlNetTopologySuiteServiceCollectionExtensions`         | service extension    | admits plugin services                |
|  [03]   | `NpgsqlNetTopologySuiteDbFunctionsExtensions`               | function surface     | projects PostGIS functions            |
|  [04]   | `NpgsqlNetTopologySuiteOptionsExtension`                    | options extension    | carries plugin policy                 |
|  [05]   | `NetTopologySuiteDataSourceConfigurationPlugin`             | data source plugin   | enables geometry wire on data source  |
|  [06]   | `NpgsqlNetTopologySuiteTypeMappingSourcePlugin`             | mapping plugin       | resolves geometry column mappings     |
|  [07]   | `NpgsqlGeometryTypeMapping<TGeometry>`                      | geometry mapping     | maps geometry and geography columns   |
|  [08]   | `NpgsqlJsonGeometryWktReaderWriter`                         | JSON value writer    | reads and writes geometry as WKT JSON |
|  [09]   | `NpgsqlNetTopologySuiteMethodCallTranslatorPlugin`          | method plugin        | translates geometry methods           |
...
| [INDEX] | [SYMBOL]                                          | [PACKAGE_ROLE]     | [CAPABILITY]                          |
| :-----: | :------------------------------------------------ | :----------------- | :------------------------------------ |
|  [01]   | `NpgsqlNetTopologySuiteConventionSetPlugin`       | convention plugin  | adds PostGIS extension convention     |
|  [02]   | `NpgsqlNetTopologySuiteExtensionAddingConvention` | convention         | finalizes PostGIS extension on model  |
|  [03]   | `NpgsqlNetTopologySuiteSingletonOptions`          | singleton options  | carries resolved geometry options     |
|  [04]   | `INpgsqlNetTopologySuiteSingletonOptions`         | singleton contract | singleton options contract            |
|  [05]   | `NpgsqlNetTopologySuiteCodeGeneratorPlugin`       | scaffolding plugin | emits plugin admission in scaffolding |
|  [06]   | `NpgsqlNetTopologySuiteDesignTimeServices`        | design services    | admits design tooling                 |
...
| [INDEX] | [SYMBOL]                           | [PACKAGE_ROLE]        | [CAPABILITY]                          |
| :-----: | :--------------------------------- | :-------------------- | :------------------------------------ |
|  [01]   | `NpgsqlNetTopologySuiteExtensions` | type-mapper extension | admits geometry wire codecs on mapper |
...
| [INDEX] | [SYMBOL]             | [PACKAGE_ROLE]   | [CAPABILITY]                        |
| :-----: | :------------------- | :--------------- | :---------------------------------- |
|  [01]   | `Geometry`           | geometry root    | owns spatial algebra and predicates |
|  [02]   | `Point`              | point geometry   | carries X, Y, Z coordinates         |
|  [03]   | `LineString`         | curve geometry   | carries ordered coordinates         |
|  [04]   | `LinearRing`         | ring geometry    | closes a coordinate sequence        |
|  [05]   | `Polygon`            | surface geometry | carries shell and holes             |
|  [06]   | `MultiPoint`         | collection       | aggregates points                   |
|  [07]   | `MultiLineString`    | collection       | aggregates line strings             |
|  [08]   | `MultiPolygon`       | collection       | aggregates polygons                 |
|  [09]   | `GeometryCollection` | collection       | aggregates mixed geometries         |
...
| :-----: | :----------------------------------------- | :-------------------- | :----------------------------------------------- |
|  [01]   | `UseNetTopologySuite`                      | provider option       | maps geometry values in EF with precision policy |
|  [02]   | `AddEntityFrameworkNpgsqlNetTopologySuite` | service extension     | registers plugin services                        |
|  [03]   | `UseNetTopologySuite`                      | type-mapper extension | admits wire codecs on `INpgsqlTypeMapper`        |
...
| [INDEX] | [SURFACE]          | [CALL_SHAPE]            | [CAPABILITY]                |
| :-----: | :----------------- | :---------------------- | :-------------------------- |
|  [01]   | `Distance`         | `DbFunctions` extension | measures spheroid distance  |
|  [02]   | `IsWithinDistance` | `DbFunctions` extension | tests spheroid proximity    |
|  [03]   | `DistanceKnn`      | `DbFunctions` extension | orders by KNN distance      |
|  [04]   | `Transform`        | `DbFunctions` extension | reprojects to a target SRID |
|  [05]   | `Force2D`          | `DbFunctions` extension | drops Z and M ordinates     |
...
| [INDEX] | [SURFACE]                                   | [CALL_SHAPE]      | [CAPABILITY]            |
| :-----: | :------------------------------------------ | :---------------- | :---------------------- |
|  [01]   | `GeometryFactory.CreatePoint`               | factory call      | creates points          |
|  [02]   | `GeometryFactory.CreateLineString`          | factory call      | creates line strings    |
|  [03]   | `GeometryFactory.CreatePolygon`             | factory call      | creates polygons        |
|  [04]   | `Geometry.Intersects` / `Geometry.Contains` | spatial predicate | tests spatial relations |
|  [05]   | `Geometry.Distance` / `Geometry.Buffer`     | spatial operation | measures and dilates    |
|  [06]   | `Geometry.AsText` / `Geometry.AsBinary`     | projection call   | emits WKT and WKB       |
