...
- `libs/dotnet/Rasm.Rhino/.api/api-eto-runtime.md`: the portable clock the rail falls back to off macOS, and the density surface the backing-scale read supersedes on macOS.
