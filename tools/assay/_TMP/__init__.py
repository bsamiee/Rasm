...
precede the first transitive ``import tools.assay._TMP.core.model``, since ``msgspec``
...
# `import tools.assay._TMP.core.model` — the claw rewrites at import while msgspec resolves
...
from tools.assay._TMP.composition.settings import AssaySettings, LogFormat  # noqa: PLC2701  # intra-staging import; _TMP is the package root
from tools.assay._TMP.core.aspect import ring_processor  # noqa: PLC2701  # intra-staging import; recent-events ring seam
