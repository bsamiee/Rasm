...
- prefer the native `OtlpLogger` lane; reach for this SDK exporter only for SDK-only log-pipeline capability, and record it as an `[R3]` non-collapsed dependency.
