...
public abstract partial record GeneratedError : Expected {
    ...
    public sealed record Missing : GeneratedError { public Missing() : base("<generated-error-missing>", 1) { } }
    public sealed record Rejected : GeneratedError { public Rejected() : base("<generated-error-rejected>", 2) { } }
    public sealed record Cancelled : GeneratedError { public Cancelled() : base("<generated-error-cancelled>", 3) { } }
    public sealed record Conflict : GeneratedError { public Conflict() : base("<generated-error-conflict>", 4) { } }
}
...
public static class Generators {
    ...
    public static Gen<(double[] A, double[] B, double[] C)> NearlyCollinearPoints(int dimension) {
        ...
        return ModerateMagnitude.Array[dimension].Select(ModerateMagnitude.Array[dimension], Gen.Double[-2.0, 2.0],
            ...
            .Select(Gen.Int[0, dimension - 1], Gen.Int[-8, 8], static (p, axis, steps) => {
    ...
    public static readonly Gen<byte[]> PayloadBytes = Gen.Frequency(
    ...
    public static readonly Gen<(byte[] Original, byte[] Corrupted)> CorruptedPayload =
    ...
    public static readonly Gen<Error> ErrorsFromExceptions = Gen.Int[0, 3].Select(static kind => Error.New(kind switch {
        ...
        1 => new ArithmeticException("<generated-arithmetic-exception>"),
        2 => new IOException("<generated-io-exception>"),
        _ => new FormatException("<generated-format-exception>"),
    }));
    public static Gen<Fin<T>> FinOf<T>(Gen<T> success, Gen<Error>? error = null, int successWeight = 80) =>
        Gen.Frequency(
            (successWeight, Element(success).Select(static Fin<T> (value) => value)),
    ...
    public static Gen<Validation<Error, T>> ValidationOf<T>(Gen<T> success, Gen<Error>? error = null) =>
        Gen.OneOf(
            Element(success).Select(static Validation<Error, T> (value) => value),
