...
The marker is not a decoration. Omit it when the document cannot define the numerator and denominator, or when a checklist already carries the same completion state.
...
- [information-structure.md](information-structure.md) carries container choice, table construction, code-block intent labels, and structured-record fields; this standard styles what it builds.
