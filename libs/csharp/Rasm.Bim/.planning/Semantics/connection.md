...
public static class ConnectionProjection {
    ...
    // sheet's geometry, a tendon/bearing/isolator type token, a bar's surface + overall length, the reinforcing
