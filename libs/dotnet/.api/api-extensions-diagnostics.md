...
- `Microsoft.Extensions.Diagnostics.Testing`(`tests/dotnet/.api/diagnostics-testing.md`): `MetricCollector<T>` observes one instrument's stream over a test-scoped factory this mint builds.
