...
public abstract partial record AccelerationStructure {
    ...
    // The DECODED node-link broad-phase wire `Rasm.Geometry/Spatial/index#CLASH_SEAM` `ToAcceleration` emits. Both
