...
def _projected(data: bytes, width: int, height: int, symbols: tuple[DecodedSymbol, ...], /) -> RasterFact:
    ...
    score = frozendict({
        DecodeFact.COUNT: str(len(symbols)),
        DecodeFact.VALID: str(valid),
        DecodeFact.BUILD: str(len(_ROSTER)),
