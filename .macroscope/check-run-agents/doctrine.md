...
- Seam-ledger breaks: a cross-folder member edit without its mirrored seam row and composing-fence sweep in the same change.
- Marker misuse: status or research vocabulary outside the closed set, or a resolved research row left as a tombstone.

Settled corpus law outranks intuition — a shape the owning page rules is never a finding; finding nothing after a genuine pass is a first-class verdict, stated plainly.
