...
public sealed class AlignKindLaws {
    ...
    public void KeysAreDistinctAndNonClusterInputsFail() {
        ...
        VectorCloud ring = new VectorCloud.PolylineCase(Vertices: AlignGens.Tetra, Tolerance: AlignGens.Model);
        ...
        Spec.ForAll(Gen.OneOfConst(AlignGens.Kinds), kind =>
            Spec.FailCategory(kind.AlignDetailed(source: ring, target: cluster, key: AlignGens.Key), category: "Input"));
    }
}
