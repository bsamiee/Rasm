...
- [04]-[OBSERVATION_SEAMS]: AppUi marshal seam; instrument tap; the `ProgressWireMap` transcription and the `ProgressStream` server-stream this branch serves.
