...
const gatePrompt = (ordered) =>
    [
        DOCTRINE,
        '',
        'TASK: JUSTIFICATION GATE (default-off; new pages admit only here). Diff the doctrine blocks above against the ON-DISK README laws + atlas: every law, ' +
