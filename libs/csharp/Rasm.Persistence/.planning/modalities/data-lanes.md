...
|   [5]   | ANALYTICAL_LANE | Analytical read lane; live attach; parquet, tabular, shred; DuckLake catalog |
...
| [INDEX] | [ROW]                  | [SURFACE]                                                                | [LAW]                                                                                                                                       |
| :-----: | :--------------------- | :----------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------ |
|  [11]   | lakehouse catalog mount | `INSTALL ducklake; LOAD ducklake; ATTACH 'ducklake:postgres:…' AS lake (DATA_PATH 's3://…')` raw SQL on `DuckDBCommand` | metadata catalog in the `provisioning#TIMESCALE_PROVISIONING` PG tier, data files in the `stores-remote/object-store#OBJECT_RESIDENCE` blob lane; `LakehouseKind` renders the `ATTACH` clause per backend |
