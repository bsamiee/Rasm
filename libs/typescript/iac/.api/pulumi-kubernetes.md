...
| [INDEX] | [GROUP]                       | [KEY KINDS the `kube` rows compose]                                                         |
| :-----: | :---------------------------- | :----------------------------------------------------------------------------------------- |
...
|  [08]   | `version` / `devel`     | `Input<string>` pinned version / include pre-releases                                  |
...
|  [02]   | `yaml.v2.ConfigGroup`           | the v2 SSA-aware manifest component                                                       |
