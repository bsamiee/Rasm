...
- `SharpGLTF`(`libs/csharp/.api/api-sharpgltf.md`): a decoded `DMesh3` re-emits through the glTF schema and toolkit builders as the export counterpart to this decode leg.
