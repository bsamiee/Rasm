...
include:
  - "tools/rhino-bridge/**"
  - "tests/dotnet/tools/**"
  - "tests/dotnet/scenarios/**"
---

# [RHINO_BRIDGE]

Rhino-bridge carries live-host scenario proof; its wire definition is frozen and its Supervisor fold is the verdict authority.

- The bridge wire definition is additive-only: renaming or reusing an existing field, union discriminator, status rank, or exit code is a finding.
...
- Bridge protocol changes land with their wire/Supervisor suite change under `tests/dotnet/tools/rhino-bridge`, or they do not land.
