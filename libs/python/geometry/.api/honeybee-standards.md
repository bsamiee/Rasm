...
- rail: energy-modeling
- Entire code surface: two absolute-path strings to the bundled default-library JSON. There are no classes, functions, or types — the package is a resource carrier.
