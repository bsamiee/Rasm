...
flowchart LR
    ...
    Brep --> GeometryLease
    linkStyle 3,4,6,12 stroke:#FF5555,stroke-width:3px,color:#F8F8F2
    linkStyle 13,14,15,16,17 stroke:#50FA7B,color:#F8F8F2
    classDef primary fill:#44475A,stroke:#FF79C6,color:#F8F8F2
    classDef success fill:#50FA7BBF,stroke:#50FA7B,color:#282A36
    classDef error fill:#FF555580,stroke:#FF5555,color:#F8F8F2
    classDef boundary fill:#282A36,stroke:#BD93F9,color:#F8F8F2
    class Classify,NativeAdmit,ValueAdmit,Dispatch,Borrowed,Point,Curve,Surface,Brep primary
    class GeometryLease success
    class Fault error
    class Raw boundary
```
