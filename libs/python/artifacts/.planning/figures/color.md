    ...
    async def _compute(self) -> object:
        match self.op:
            ...
            case ColorOp.MANAGED:
                ...
                return await to_process.run_sync(_icc_apply, toned, self.params["src_profile"], self.params["dst_profile"], self.params["intent"])
            case _:
