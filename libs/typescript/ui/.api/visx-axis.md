# [@visx/axis] — the axis as a React component: one generic `Axis` dispatched by `Orientation`, tick policy as typed props, labels rendered through the visx SVG text engine
