...
- strata seam: MathNet is a direct Materials NuGet pin, never a `Rasm.Compute` project reference; the acyclic strata forbids the AEC-to-app-platform edge. The fit follows the shared thin-QR doctrine without realizing a project edge.
