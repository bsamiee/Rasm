...
public sealed partial class MeshSampleKind {
    ...
    // ONE Stat.Of fold serves every valence summary row; the projected moment quantizes banker's-rounded.
