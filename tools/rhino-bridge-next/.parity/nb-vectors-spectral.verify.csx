...
Scenario.Run("nb-vectors-spectral", CAPTURE_PATH, (key, facts) => {
    string root;
    ...
    string[] expected = new[] { "SpectralDec", "SpectralDescriptor", "SpectralEdgeConnection" };
    RunCorpus(root, "tests/csharp/libs/Rasm.Scenarios/bin/Release/net10.0/Rasm.Scenarios.dll", expected, facts);
});
