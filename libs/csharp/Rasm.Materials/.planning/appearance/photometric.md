...
public sealed partial class PhotometricQuantity {
    ...
    public Fin<double> Coerce(double value, Enum unit, double efficacyRatio) =>
        AliasOf.Match(
            ...
            None: () => UnitAlgebra.Numeric(value, unit, unit).Map(si =>
