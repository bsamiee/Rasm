...
- Exemption: the acquire body is the platform-forced registration boundary — the global manager install and the composed unload closure are the SDK's own imperative contract.
