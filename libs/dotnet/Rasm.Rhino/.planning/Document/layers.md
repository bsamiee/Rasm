...
- Packages: Google.Protobuf (`libs/dotnet/.api/api-protobuf.md` — recursive generated messages and `MessageExtensions.ToByteArray`); Celly.Protovalidate (`libs/dotnet/.api/api-celly-protovalidate.md` — descriptor rules at emit); Rasm.Contracts (`libs/dotnet/Rasm.Contracts/.api/rasm-contracts.md` — generated organization family); Riok.Mapperly (`libs/dotnet/.api/api-mapperly.md` — recursive target-complete mapping); kernel `Rasm.Domain` identity; `Document/tables.md`; `Document/session.md`; BCL inbox.
