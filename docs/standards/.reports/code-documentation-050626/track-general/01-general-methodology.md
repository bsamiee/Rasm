...
Assigned output: `.reports/code-documentation-050626/track-general/01-general-methodology.md`.
...
- `CLAUDE.md`
- root `AGENTS.md`
- `~/.codex/memories/MEMORY.md` entries for the June 4-5 `docs/standards` rebuild, reference rewrite, metadata cleanup, and `.reports/` handling.
