...
[WORKTREE_CONTEXT]:
- `git status --short -- .reports/code-documentation-050626 docs/standards/reference/code-documentation.md ...` showed `docs/standards/reference/code-documentation.md` already modified before this report write.
...
1. Read memory routing for recent `docs/standards` work. Memory established that active standards files outrank `.reports/` and that `.reports/` is source material only.
...
10. Wrote only this assigned `.reports/` report.

## [10][CLOSE_CHECK]

- [x] Assigned report file created at `.reports/code-documentation-050626/track-general/03-general-security-inline.md`.
