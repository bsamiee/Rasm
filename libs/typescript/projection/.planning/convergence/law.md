...
- [1]-[CONVERGENCE_LAW]: Owns the `opLogEntryArb`/`conflictReceiptArb` arbitraries, the `permutedPairArb` delivery-order arbitrary, and the `convergenceLaw` commutativity/idempotence law suite.
