...
- [1]-[PROGRAM]: linear / integer / global / constrained / assignment math programs over `scipy.optimize` folding one content-keyed `ProgramReceipt` on the one `ProgramIntent` owner.
