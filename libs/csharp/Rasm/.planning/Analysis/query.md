...
- Receipt: `Validation<Error, Seq<TOut>>` is the public result carrier with no dedicated receipt rail; faults accumulate the `Domain/rails` `Fault` union, `KernelFault.Unsupported` the host probe discriminant.
