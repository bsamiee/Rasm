...
| :-----: | :--------------------- | :--------------- | :-------------------------------------------- |
|  [01]   | `algebra.OnnxOperator` | operator base    | base class for ONNX operator node builders    |
|  [02]   | `algebra.onnx_ops`     | operator module  | pre-built ONNX standard operator node classes |
|  [03]   | `algebra.custom_ops`   | custom op module | support for custom ONNX op nodes              |
|  [04]   | `algebra.type_helper`  | type utilities   | helpers for ONNX type annotation and mapping  |
|  [05]   | `algebra.graph_state`  | graph state      | state carrier during ONNX graph construction  |
