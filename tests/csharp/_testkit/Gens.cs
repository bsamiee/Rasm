...
public static class Gens {
    ...
    // Copying canonical planes preserves basis orientation while varying origin.
    ...
    // --- [DOMAIN_SMARTENUMS]
    // Plural names avoid SmartEnum type/member collisions.
    ...
    // Pure-data mesh fixtures keep native handle ownership out of generators.
    ...
    // --- [MATRIX_FIXTURES]
    // Caller-owned dimensions stay loud when matrix invariants break.
