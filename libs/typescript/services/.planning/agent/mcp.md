...
- [1]-[MCP_TRANSPORT]: owns the decode of the host tool-catalog into an `@effect/ai` `Toolkit`, the progress SSE fold, the cost-preview gate, the receipt reconstruction, and the resume-token replay.
