...
[ADMIT_OPENFEATURE]-[COMPLETE]: `OpenFeature` 2.14.0 pinned + referenced (in-memory provider ships in the core SDK); README `[FEATURE_FLAGS]` group and `.api/api-openfeature.md` authored.
