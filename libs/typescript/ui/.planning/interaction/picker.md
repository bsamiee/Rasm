...
- [1]-[PICKER_BEHAVIOR]: the closed `PickerBehavior` `Data.TaggedEnum` over four arms (`color`, `date`, `filePreview`, `fileUpload`), and the total `applyPicker` `$match` dispatch over those arms.
