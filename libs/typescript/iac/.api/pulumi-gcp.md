...
- version: `9.29.0`
- license: `Apache-2.0`
- build-floor: peer `@pulumi/pulumi ^3.142.0` (the engine owns `CustomResource`/`Output`/`Input`); the `pulumi-resource-gcp` plugin binary provisions against the Google APIs
...
| [INDEX] | [SELFHOSTED-K8S CONCERN]           | [GCP SERVICE.RESOURCE]                                             |
| :-----: | :--------------------------------- | :---------------------------------------------------------------- |
