---
name: ifc
description: Work with IFC/BIM models through the ifc MCP (live, in-memory IfcOpenShell) and the ifcopenshell batch CLI. Use for IFC files, BIM models, IfcOpenShell, tessellation, IDS/ifctester validation, BCF, GlobalId, Pset/Qto, clash detection, quantity takeoff, or inspecting and converting .ifc files.
---
