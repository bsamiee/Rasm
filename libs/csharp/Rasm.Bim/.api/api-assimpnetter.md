...
- assembly: `AssimpNetter` (legacy root namespace `Assimp`; the XML-doc file is `AssimpNet.xml`)
- namespace: `Assimp`
...
|  [06]   | `ShadingMode` / `BlendMode` | scene-exchange | legacy shading model and material blend-mode enums |
