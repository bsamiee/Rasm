...
/// <remarks>
/// The first <see cref="PdfSharp.Drawing.XFont"/> construction throws while <see cref="GlobalFontSettings.FontResolver"/>
/// holds no resolver. <see cref="FailsafeFontResolver"/> substitutes a bundled face for every request the platform
/// cannot resolve, and the setter tolerates repeated assignment.
/// </remarks>
