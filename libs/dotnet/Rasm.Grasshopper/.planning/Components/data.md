...
- Entry: `Coerce.To<TOut>(raw, ledger, scope)` is the one typed conversion entry; broker candidates settle by first success and LanguageExt combines plural failures without a package-local aggregate case.
