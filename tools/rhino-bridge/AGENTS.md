...
- Real diagnostics on a `*.csproj` that targets Rhino or Grasshopper — `scripts/rhino.sh bridge check <project>`.
...
- Lower-level assembly load/unload evidence — `scripts/rhino.sh bridge load-smoke <assembly.dll>`.
