...
public readonly record struct HodgeDecomposition(Arr<double> Exact, Arr<double> Harmonic, Arr<double> CoExact, HodgeWitness Witness) : IValidityEvidence {
    public bool IsValid => ValidityClaim.All(
        ...
        ValidityClaim.CountExactly(count: Harmonic.Count, expected: Exact.Count) && TensorPrimitives.IsFiniteAll<double>(Harmonic.AsSpan()),
...
|  [09]   | Sparse assembly    | `TripletStencil`               | `Freeze → Fin<SparseMatrix>`                    |    4    |
