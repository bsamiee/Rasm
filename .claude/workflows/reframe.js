...
const doctrinePrompt = (rows) =>
    'TASK: DOCTRINE LANDER — the durable-learning terminal of a hostile reframe run. Read `docs/laws/README.md` AND ' +
    '`docs/laws/landing.md` FIRST — they own the admission table, the ' +
    'harden>extend>mint bar, the per-surface routing and justification, the laws page grammar, and the poison ' +
    'guard; obey them over any restatement. Load the `docgen` skill AND the ' +
