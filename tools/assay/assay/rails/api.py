...
``status``/``resolve``/``query``/``show`` bind params, route through ``assay.oracle`` adapters, and
...
from assay.diagnostics import cap_note, CAPTURES, fold
from assay.oracle import (
