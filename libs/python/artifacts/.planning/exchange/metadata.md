...
_EXIFTOOL_TAGS: Final[tuple[str, ...]] = (*(keys.exiftool for keys in _FIELD_KEYS.values() if keys.exiftool), "Composite:GPSLatitude", "Composite:GPSLongitude")
