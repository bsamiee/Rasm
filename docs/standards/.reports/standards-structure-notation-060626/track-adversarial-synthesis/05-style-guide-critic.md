...
Finding 8
    ...
    Correction route: Keep report packets in `.reports/AGENTS.md` and task-output surfaces. Active standards can use the same reasoning internally but should publish the resulting rule in direct prose, compact records, or examples.
    Outcome: MERGE.
