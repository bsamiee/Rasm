# [@openfeature/server-sdk] — the CNCF feature-evaluation contract the flag owner implements and answers through
...
- package: `@openfeature/server-sdk` (1.22.0, Apache-2.0, OpenFeature/CNCF)
