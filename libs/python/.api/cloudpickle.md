...
[STACKING]: cloudpickle owns one half of each worker-crossing seam — the by-value reduce of the request-direction callable — and each sibling below carries the other half, read as member-to-member wiring.
