...
[COLD_READ]:
- After the final lane, the orchestrator reads the page cold — giving no weight to the lane agents' work — and grades it on five axes — signal, coverage, card power, structure, doctrine fit — one to ten against a bar of 9.2 on each, critically, harshly, but fairly. It returns anything short for a targeted fix.
