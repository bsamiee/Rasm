...
- [1]-[ROLE_BEHAVIOR]: the `_Roles` behavior-bearing vocabulary over eight `InteractionRole` rows (politeness, behaviors, focus model), and the headless `RoleBehavior` contract keyed by role.
