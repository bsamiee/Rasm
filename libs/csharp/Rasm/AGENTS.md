...
- When changing BCL, `System.*`, or package policy, read `docs/stacks/csharp/platform-map/`.
- When adding numerical or symbolic behavior, read `docs/stacks/csharp/product-libs/mathnet/`.
