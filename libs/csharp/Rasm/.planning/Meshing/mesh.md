...
internal readonly partial record struct TuftedBaseFaces(Mesh Triangulated, int TriangleCount, int DroppedNonTriangleFaces) : IValidityEvidence {
...
internal sealed class LaplacianCache {
    ...
    // beside their owning kernels — this page names none of them; the substrate never depends downward.
