...
from rasm.runtime.faults import FAULT_CONF, IDENTITY_DERIVE, IDENTITY_FMT, SCOPES, RuntimeResult, Scope, boundary, scoped
...
def derived[T](fmt: str, source: IdentitySource, run: Callable[[Span], T]) -> RuntimeResult[T]:
...
class ContentIdentity:
    ...
    @overload
    @classmethod
    def of(cls, fmt: str, source: Source, policy: IdentityPolicy = ..., *, view: Literal["hex"], seed: Option[U64] = ...) -> RuntimeResult[str]: ...
    @overload
    @classmethod
    def of(cls, fmt: str, source: Source, policy: IdentityPolicy = ..., *, view: Literal["wire"], seed: Option[U64] = ...) -> RuntimeResult[str]: ...
    @overload
    @classmethod
    def of(
    ...
    @overload
    @classmethod
    def of(cls, fmt: str, source: Source, policy: IdentityPolicy = ..., *, view: Literal["digest"], seed: Option[U64] = ...) -> RuntimeResult[int]: ...
    @classmethod
    def of(
        cls, fmt: str, source: Source, policy: IdentityPolicy = CANONICAL_POLICY, *, view: KeyView = "value", seed: Option[U64] = Nothing
    ) -> RuntimeResult[KeyRender]:
