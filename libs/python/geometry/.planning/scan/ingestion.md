...
- [1]-[INGESTION]: source-discriminated raw-scan preprocessing under one owner over the `pdal` `IngestStage` filter graph and the `pye57` E57 structured-scan path, egressing a registration-ready `o3d.t.geometry.PointCloud`.
