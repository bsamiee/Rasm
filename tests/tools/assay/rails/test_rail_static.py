...
from tests._spec import assert_error, assert_ok, support_matrix, validity_matrix, ValidityCase  # noqa: PLC2701
...
def test_mode_family(mode: Mode, expected: tuple[Mode, ...]) -> None:
    ...
    from tools.assay.rails.static import _mode_family  # noqa: PLC0415, PLC2701
...
def test_plan_artifacts_carry_build_scope_sha_for_csharp(assay_root: AssayHarness) -> None:
    ...
    from tools.assay.rails.static import _plan_report  # noqa: PLC0415, PLC2701
