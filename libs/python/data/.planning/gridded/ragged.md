...
_AXIS_OP: "dict[AxisOp, Callable[..., ak.Array]]" = {
...
_REDUCE: "dict[Reduction, Callable[..., ak.Array]]" = {
...
flowchart LR
    ...
    Transform --> Owner
    Owner --> Arrow["to_arrow ak.to_arrow pyarrow.Array __arrow_c_stream__"]
