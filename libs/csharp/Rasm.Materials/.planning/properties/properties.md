...
namespace Rasm.Materials.Properties;   // the property-catalogue folder owner — MaterialPropertyCatalogue lives here, the Projection/material projector imports it as Rasm.Materials.Properties
...
public static class MaterialPropertyCatalogue {
    ...
    public static readonly FrozenDictionary<MaterialId, MaterialPropertyRow> Rows = new (MaterialId Id, MaterialPropertyRow Row)[] {
        ...
        // metal.steel — the generic-structural-steel grade alias the Connection/connection#CONNECTION_OWNER ConnectionItem.CapacityKey
        // resolves (a galvanized fastener/hanger whose grade is unspecified): the conservative EN 1993-1-1 S235 baseline (fy 235, fu 360),
