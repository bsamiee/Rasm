...
const _FACTS = [
    ...
    { fact: 'the runtime branch rides the workspace graph per package', pattern: /-\s*'libs\/typescript\/\*'/ },
    { fact: 'the depth-2 ui stratum rides the workspace graph', pattern: /-\s*'libs\/typescript\/ui\/\*'/ },
    { fact: 'app projects ride the workspace graph', pattern: /-\s*'apps\/\*\/\*'/ },
