...
class Probe extends Context.Tag("<scope>/Probe")<Probe, {
...
class Sender extends Context.Tag("<scope>/Sender")<Sender, {
  readonly sent: (frame: string) => Effect.Effect<void>
}>() {}
...
class Transport extends Context.Tag("<scope>/Transport")<Transport, {
...
class Gate extends Context.Tag("<scope>/Gate")<Gate, { // Gate and Journal stand in for the imported production owners
