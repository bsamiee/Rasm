...
|  [08]   | `get_segments()` / `get_bbox()` / `elements`                  | query     | flattened `Segment*` stream / bounding box / placed `list[Element]` |
