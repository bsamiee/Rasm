...
public readonly partial struct SymbolicExpr {
    ...
    // derived from the expression in ValidateFactoryArguments, never trusted from the Create slot.
    [MemberEqualityComparer<ComparerAccessors.Default<UInt128>, UInt128>]
    public UInt128 ContentKey { get; }

    static partial void ValidateFactoryArguments(ref ValidationError? validationError, ref Expression expression, ref UInt128 contentKey) =>
