...
public static class EnergyDerive {
    ...
    static Option<double> Height(ElementGraph graph, NodeId space) =>
        graph.EdgesAt(space).Choose(e =>
            ...
            .Filter(static qs => qs.Bag.SetName == EnergyProjector.SpaceQuantitySet).Head
