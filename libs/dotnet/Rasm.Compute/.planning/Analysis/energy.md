...
- Result: `AssessmentResult` carries the energy discipline, route, content key, elapsed time, translator warnings, conditioning-claim census, version probe, and retained scratch directory; construction or reported-version failures rail before simulation.
