...
- [1]-[PROVISIONING]: owns the data/compute/observe tier model, the cloud/self-hosted two-mode dispatch, secrets, state, bootstrap, `StackOutputs`, `PolicyGuard`, and the `ObservabilityStack`.
