...
def _proximity(tag: Tag, pts: np.ndarray, qs: np.ndarray, scale: float, reduce: "KdReduction") -> SpatialEvidence:
    ...
    # ternary — run the scipy reduction, or fall to this tag's floor row when the wheel is absent so
