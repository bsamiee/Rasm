...
- `docs/standards/_reports/standards-structure-notation-060626/track-root-corpus/01-root-shared-corpus.md`.
...
- `docs/standards/_reports/standards-structure-notation-060626/track-external-research/02-mermaid-renderer-proof.md`.
- `docs/standards/_reports/standards-structure-notation-060626/track-external-research/07-proof-uncertainty-stale-sources.md`.
- `docs/standards/_reports/standards-structure-notation-060626/track-external-research/10-machine-consumed-markdown-ledgers.md`.
...
- The only close gate for this report is `git diff --check -- docs/standards/_reports/standards-structure-notation-060626`.
