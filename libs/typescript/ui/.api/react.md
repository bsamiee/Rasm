...
|  [07]   | `createContext` / `forwardRef` / `createRef` / `Component` / `PureComponent`            | legacy         | present but never authored — ref-as-prop, `<Context>` provider, and function components supersede the class/forwardRef forms |
