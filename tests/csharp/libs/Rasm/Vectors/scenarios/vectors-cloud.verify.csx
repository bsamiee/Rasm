...
Scenario.Run("vectors-cloud-neighborhood", CAPTURE_PATH, (key, facts) => {
    ...
    Probe.Require(duplicateAdmission.InputCount == 3 && duplicateAdmission.OutputCount == 2 && duplicateAdmission.InputDuplicateCoordinateCount == 1 && duplicateAdmission.MergedCoordinateCount == 1 && duplicateAdmission.Deduplicated && duplicateAdmission.Tolerance >= 0.0, $"dedup.admission={duplicateAdmission}");
