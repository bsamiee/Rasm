...
of generated profile classes — 2299 American (AISC Shapes Database) and 558 European (EN 10365:2017)
...
| [INDEX] | [SYMBOL] | [PACKAGE_ROLE] | [CAPABILITY] |
|:-----: |:--------------- |:------------- |:---------------------------------------------------------------------------- |
| [01] | `American` | identity enum | 2299 AISC section names (`W44x408`, `HSS…`, `Pipe…`) — the `CreateAmerican` key |
