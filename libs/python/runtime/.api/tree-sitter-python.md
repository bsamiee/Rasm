...
| :-----: | :----------------- | :------------ | :-------------------------- |
|  [01]   | `HIGHLIGHTS_QUERY` | query source  | syntax-highlight query text |
|  [02]   | `TAGS_QUERY`       | query source  | symbol-tags query text      |
...
| :-----: | :--------- | :------------- | :----------------------------------------- |
|  [01]   | `language` | grammar        | grammar pointer for `tree_sitter.Language` |
