...
public sealed class ExtractSurfacesComponent : AnalysisComponent<object> {
    protected override Seq<IBridgeOutput<object>> Outputs { get; } = Seq<IBridgeOutput<object>>(
        new BridgeOutput<object, Brep>(
            ...
            Query: Analysis.Query.Faces<object, Brep>(aspect: new Faces.All())),
        new BridgeOutput<object, Brep>(
            Name: "Top Surface",
            Code: "TS",
            ...
            Query: Analysis.Query.Faces<object, Brep>(aspect: new Faces.Top())),
        new BridgeOutput<object, Brep>(
            Name: "Bottom Surface",
            Code: "BS",
            Description: "Face(s) with the minimum area-centroid world-Z; ties returned within absolute tolerance.",
            Query: Analysis.Query.Faces<object, Brep>(aspect: new Faces.Bottom())),
        new BridgeOutput<object, Brep>(
            ...
            Query: Analysis.Query.Faces<object, Brep>(aspect: new Faces.At())),
        new BridgeOutput<object, Plane>(
            ...
            Query: Analysis.Query.Faces<object, Plane>(aspect: new Faces.At())));
