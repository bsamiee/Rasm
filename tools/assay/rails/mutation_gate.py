...
def _scan() -> tuple[SourceFileMutationData, ...]:
    """Load persisted mutmut metadata once for both score and triage projections.

    Returns:
        Loaded source-file mutation records.
    """
...
def _survivors(scanned: Iterable[SourceFileMutationData]) -> SurvivorReport:
    """Project scanned metadata into per-file triage clusters and top survivor diffs.
