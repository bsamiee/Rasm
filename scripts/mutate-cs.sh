...
readonly OUTPUT_PATH="${MUTATE_OUTPUT:-${ROOT_DIR}/.artifacts/mutation/rasm}"
readonly THRESHOLD_HIGH="${MUTATE_THRESHOLD_HIGH:-80}"
readonly THRESHOLD_LOW="${MUTATE_THRESHOLD_LOW:-70}"
readonly THRESHOLD_BREAK="${MUTATE_THRESHOLD_BREAK:-60}"
