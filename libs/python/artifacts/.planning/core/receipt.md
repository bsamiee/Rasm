...
class ArtifactReceipt:
    ...
    register: tuple[ContentKey, str, int, str, str, str, int] = case()
    ...
    @classmethod
    def Register(cls, key: ContentKey, kind: str, sheets: int, suitability: str, revision: str, classification: str, bytes_: int, /) -> Self:
        return cls(register=(key, kind, sheets, suitability, revision, classification, bytes_))
...
_KEYS: frozendict[ArtifactKind, tuple[str, ...]] = frozendict({
    ...
    "register": ("kind", "sheets", "suitability", "revision", "classification", "bytes"),
