...
- Surface: `UsePlatformDetect`
- Owner: `AppBuilderDesktopExtensions`
- Signature: `(this AppBuilder) -> AppBuilder`
- Dispatch: detects the RID and calls `UseWin32`, `UseAvaloniaNative`, or `UseX11`, then calls `UseSkia`.
- Composition: returns the builder for fluent chaining from the Avalonia core configuration.
