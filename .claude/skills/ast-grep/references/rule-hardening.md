...
Escaped module strings stay excluded until their decoded value is known.
...
Relations stay where they establish fields, captures, or traversal stops.
Duplication stays when parameter forwarding loses captures or document-local rewriters cannot be shared.
