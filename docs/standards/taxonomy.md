...
[IMPORTANT] Structure encodes semantics—each element type carries meaning.<br>
...
[IMPORTANT]:
- [ALWAYS] **Dictum:** Include exactly one per section.
...
---
## [2][MARKERS]
>**Dictum:** *Sigils encode state and function.*
...
---
## [3][REFERENCES]
>**Dictum:** *Notation enables precise cross-reference.*
