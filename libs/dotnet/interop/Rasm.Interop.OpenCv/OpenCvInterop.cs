...
public static class OpenCvInterop {
    ...
    /// <remarks><see cref="CvInvoke.OpenCVModuleList"/> returns library names rather than built modules, and even a full build omits modules, freetype on macOS among them</remarks>
