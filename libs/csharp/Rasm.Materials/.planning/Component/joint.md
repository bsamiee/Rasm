...
using Rasm.Element;                  // MaterialId (the seam-carried material identity the JointSection AppearanceId/SubstanceId reference)
...
public sealed partial class ElectrodeClass {
    public static readonly ElectrodeClass E60  = new("e60",  tensileMpa: 415.0, specification: "AWS A5.1", substanceId: "steel.e60",  appearanceId: "metal.iron");
    public static readonly ElectrodeClass E70  = new("e70",  tensileMpa: 485.0, specification: "AWS A5.1", substanceId: "steel.e70",  appearanceId: "metal.steel");
    public static readonly ElectrodeClass E80  = new("e80",  tensileMpa: 550.0, specification: "AWS A5.5", substanceId: "steel.e80",  appearanceId: "metal.steel");
    public static readonly ElectrodeClass E90  = new("e90",  tensileMpa: 620.0, specification: "AWS A5.5", substanceId: "steel.e90",  appearanceId: "metal.steel");
    public static readonly ElectrodeClass E100 = new("e100", tensileMpa: 690.0, specification: "AWS A5.5", substanceId: "steel.e100", appearanceId: "metal.steel");
    public static readonly ElectrodeClass E110 = new("e110", tensileMpa: 760.0, specification: "AWS A5.5", substanceId: "steel.e110", appearanceId: "metal.steel");
...
public sealed partial class AdhesiveClass {
    public static readonly AdhesiveClass Epoxy              = new("epoxy",               lapShearMpa: 30.0, peelNmm: 5.0,  serviceCelsius: 80.0,  structuralBiteMpa: 6.0,  substanceId: "adhesive.epoxy");
    public static readonly AdhesiveClass Methacrylate       = new("methacrylate",        lapShearMpa: 25.0, peelNmm: 12.0, serviceCelsius: 100.0, structuralBiteMpa: 5.0,  substanceId: "adhesive.methacrylate");
    public static readonly AdhesiveClass Polyurethane       = new("polyurethane",        lapShearMpa: 15.0, peelNmm: 20.0, serviceCelsius: 90.0,  structuralBiteMpa: 2.0,  substanceId: "adhesive.polyurethane");
    public static readonly AdhesiveClass SiliconeStructural = new("silicone-structural", lapShearMpa: 1.0,  peelNmm: 8.0,  serviceCelsius: 150.0, structuralBiteMpa: 0.14, substanceId: "sealant.silicone-structural");
...
public sealed partial class StudGrade {
    public static readonly StudGrade Sd1  = new("sd1",   yieldMpa: 350.0, ultimateMpa: 450.0, substanceId: "steel.sd1");
    public static readonly StudGrade Sd2  = new("sd2",   yieldMpa: 235.0, ultimateMpa: 400.0, substanceId: "steel.sd2");
    public static readonly StudGrade Sd3  = new("sd3",   yieldMpa: 350.0, ultimateMpa: 500.0, substanceId: "steel.sd3");
    public static readonly StudGrade AwsA = new("aws-a", yieldMpa: 340.0, ultimateMpa: 420.0, substanceId: "steel.aws-a");
    public static readonly StudGrade AwsB = new("aws-b", yieldMpa: 350.0, ultimateMpa: 450.0, substanceId: "steel.aws-b");
...
public abstract partial record JointSection {
    ...
    // steel for a stud), INDEPENDENT from SubstanceId by the component#COMPONENT_OWNER two-slot law — the
    ...
    // The substance whose Properties/properties#MATERIAL_PROPERTY_CATALOGUE Mechanical row the design seam reads.
    public MaterialId SubstanceId => Switch(
        weld:     static w => w.Electrode.Substance,
        adhesive: static a => a.Class.Substance,
        stud:     static s => s.Grade.Substance);
...
public static class ComponentCatalogue {
    ...
    static Fin<(ComponentId Id, Component Item)> WeldOf(WeldRow r, Op key) =>
        ...
        from item in Component.Of(ComponentFamily.Joint, r.Designation, new ComponentSection.Joint(section), Coring.None, Standard, section.SubstanceId, section.AppearanceId, key)
