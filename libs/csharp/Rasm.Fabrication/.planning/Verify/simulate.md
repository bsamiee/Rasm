...
public static class Simulate {
    ...
    public static Fin<SimulationReceipt> Execute(
        CutProgram program, SimulatePolicy policy, FabricationTap? tap = null, SpanBand? band = null) =>
