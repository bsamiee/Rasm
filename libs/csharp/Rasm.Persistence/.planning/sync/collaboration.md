...
|   [6]   | graph checkout granularity      | `GraphDiff` set-difference over `Holds`          | whole-graph `CopyGraph` and partial `SubtreeFetch` dial one algebra; wire family at `Compute/remote#PROTO_VOCABULARY` |
