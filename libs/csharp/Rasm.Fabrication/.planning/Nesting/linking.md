...
public static class Linking {
    ...
    static Seq<Edge3> CutUp(Stock stock, Seq<Loop> placed, LinkPolicy policy) {
        ...
        return grid.Bind(line => PolygonAlgebra.ClipOpenPath(line, inflated).Outside);
    }
...
flowchart LR
    ...
    Stock["Stock.Outline"] -->|"grid × ClipOpenPath OUTSIDE"| CutUp["SkeletonCutUp slitting"]
