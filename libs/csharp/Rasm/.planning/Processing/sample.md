...
public readonly record struct PowerCcvtReceipt(
    ...
    public bool IsValid => ValidityClaim.All(
        ...
        ValidityClaim.Of(DualSolve.Map(static solve => solve.IsUsable).IfNone(noneValue: true)),
