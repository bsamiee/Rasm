...
// Checker SPI (@stryker-mutator/api/check, core [04]) the returned instance implements — `group` optional; this plugin implements it for batching.
...
```ts signature
// Generated plugin option bag (src-generated/typescript-checker-options.d.ts) — the ONLY plugin-owned field.
