...
[GENERATED]:
- [01]-[CATALOGUE](https://github.com/bsamiee/Rasm/blob/main/libs/dotnet/Rasm.Contracts/.api/rasm-contracts.md): Symbol grammar and admission law.
- [02]-[EMISSION](https://github.com/bsamiee/Rasm/tree/main/libs/dotnet/Rasm.Contracts/Generated): Swept message, descriptor, and service sources.
...
- Publisher CloudEvents and gRPC health types stay with their own packages, so nothing here shadows a package-shipped .NET owner.
