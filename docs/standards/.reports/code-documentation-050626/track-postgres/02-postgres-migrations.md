...
Assigned output: `.reports/code-documentation-050626/track-postgres/02-postgres-migrations.md`.
...
- `CLAUDE.md`
- root `AGENTS.md`
- `~/.codex/memories/MEMORY.md` lines for current `docs/standards` routing, `.reports/` status, proof ownership, and docs-only validation.
...
- [x] Edited only `.reports/code-documentation-050626/track-postgres/02-postgres-migrations.md`.
