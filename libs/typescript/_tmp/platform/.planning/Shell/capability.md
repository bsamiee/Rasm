...
- [01]-[BROWSER_CAPABILITY]: the closed `CapabilityKind` axis, the per-kind `PermissionState` cell table, the `query`/`request` total dispatch, and the native storage-persist grant.

## [02]-[BROWSER_CAPABILITY]
