...
- [OBFUSCATED]: `rm${IFS}-rf${IFS}/`, a quoted `"rm" -rf`, and a `bash -c 'rm -rf /'` wrapper prove the command-normalization move before matching (the fragments example carries it).
