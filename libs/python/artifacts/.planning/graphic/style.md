...
- Boundary: no color math, compositing vocabulary, pen truth, shaping, layout, font transformation, chart/table/diagram rendering, or sheet geometry. Theme rows carry canonical substrate values and typed per-plane bindings; no `Map[str, str]`, nullable feature preset, identity, or result survives inward.
