export const meta = {
    name: 'stack-py',
    description: 'Harden Python stack doctrine',
    phases: [
        {
            title: 'Inventory',
...
const APISTACK_SUBSTRATE = [
    ...
    'Cite ONLY members confirmed in the actual .api catalog file; a member you cannot verify is a PHANTOM to delete (verify novel members via ' +
        '`uv run assay api`; assay blocked or unavailable, the package`s official surface via Context7/exa/tavily owns the fallback). An ' +
