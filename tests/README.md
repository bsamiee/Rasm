...
Each reusable property definition must include a known counterexample. A property that accepts its counterexample is vacuous and fails at registration.
...
- A .NET or TypeScript Stryker run that discovers zero mutants fails.
