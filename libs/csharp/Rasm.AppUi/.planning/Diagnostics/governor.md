...
public sealed record GpuTimeline(long FrameOrdinal, Seq<PassTiming> Passes, Seq<PipelineStat> Stats) {
    ...
    // Migrate deepens FrameReceipt.Gpu ONLY when every pass resolved its timestamp pair — a mixed projected/measured sum never enters the measured column.
