...
public readonly record struct ClosestHit(
    ...
    private static readonly FrozenSet<Type> Projectable = new[] {
        typeof(ClosestHit), typeof(Point3d), typeof(double), typeof(Point2d), typeof(Vector3d), typeof(Plane), typeof(ComponentIndex), typeof(MeshPoint),
    }.ToFrozenSet();
...
|  [05]   | Surface evaluation    | `NormalAt`/`FrameAt`/`SurfaceUv`/`SurfaceSampleUv` | orientation-corrected surface members     | `Fin<Vector3d>`/`Fin<Plane>`/`Fin<Point2d>`  |    4    |
