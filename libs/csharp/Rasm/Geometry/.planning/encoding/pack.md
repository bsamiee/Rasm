...
| :-----: | :------------------ | :-------------------------- | :------------------------------------------------------------------------------------------------------------ | :------------------------------------------- | :-----: |
|   [1]   | Geometry encoding   | `PackOp`                    | `[Union]` (`PointCloud`/`MeshPatch`/`VoxelGrid`/`BrepPatch`) over one `EncodedStore` + `Apply`                 | `Encoding.Apply → Fin<EncodedGeometry>`      |    4    |
